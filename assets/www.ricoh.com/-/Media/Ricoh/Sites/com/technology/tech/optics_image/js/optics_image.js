  ...
  function ListSet(callback) {
    ...
    $.getJSON(path, function (data) {
      $(data.item).each(function () {
        ...
        var contentHtml = '';
        var page = this.e_url;
        if((page != '') && ((this.F2a != '') || (this.F2b != '') || (this.F2c != '') || (this.F2d != '') || (this.F2e != ''))){
          ...
          // HTMLコンテンツを作成
          contentHtml = '<a href="' + url + '" class="c-linkTile__item icon-hidden" data-group="' + this.F2a + ' '+ this.F2b + ' '+ this.F2c + ' '+ this.F2d + ' '+ this.F2e + '" target="' + window + '">' +
