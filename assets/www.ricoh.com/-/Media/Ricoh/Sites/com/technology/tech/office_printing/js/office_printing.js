  ...
  function ListSet(callback) {
    ...
    $.getJSON(path, function (data) {
      $(data.item).each(function () {
        ...
        var contentHtml = '';
        var page = this.e_url;
        if((page != '') && ((this.P1a != '') || (this.P1b != '') || (this.P1c != '') || (this.P1d != '') || (this.P1e != '') || (this.P1f != ''))){
          ...
          // HTMLコンテンツを作成
          contentHtml = '<a href="' + url + '" class="c-linkTile__item icon-hidden" data-group="' + this.P1a + ' '+ this.P1b + ' '+ this.P1c + ' '+ this.P1d + ' '+ this.P1e + ' '+ this.P1f + '" target="' + window + '">' +
