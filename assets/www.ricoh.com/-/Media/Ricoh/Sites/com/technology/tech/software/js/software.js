  ...
  function ListSet(callback) {
    ...
    $.getJSON(path, function (data) {
      $(data.item).each(function () {
        ...
        var contentHtml = '';
        var page = this.e_url;
        if((page != '') && ((this.F3a != '') || (this.F3b != '') || (this.F3c != '') || (this.F3d != '') || (this.F3e != ''))){
          ...
          // HTMLコンテンツを作成
          contentHtml = '<a href="' + url + '" class="c-linkTile__item icon-hidden" data-group="' + this.F3a + ' '+ this.F3b + ' '+ this.F3c + ' '+ this.F3d + ' '+ this.F3e + '" target="' + window + '">' +
