  ...
  function ListSet(callback) {
    ...
    $.getJSON(path, function (data) {
      $(data.item).each(function () {
        ...
        var contentHtml = '';
        var page = this.e_url;
        if((page != '') && ((this.F6a != '') || (this.F6b != '') || (this.F6c != '') || (this.F6d != ''))){
          ...
          // HTMLコンテンツを作成
          contentHtml = '<a href="' + url + '" class="c-linkTile__item icon-hidden" data-group="' + this.F6a + ' '+ this.F6b + ' '+ this.F6c + ' '+ this.F6d + '" target="' + window + '">' +
