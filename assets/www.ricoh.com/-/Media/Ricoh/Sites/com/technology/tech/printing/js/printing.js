  ...
  function ListSet(callback) {
    ...
    $.getJSON(path, function (data) {
      $(data.item).each(function () {
        ...
        var contentHtml = '';
        var page = this.e_url;
        if((page != '') && ((this.F1a != '') || (this.F1b != '') || (this.F1c != '') || (this.F1d != '') || (this.F1e != ''))){
          ...
          // HTMLコンテンツを作成
          contentHtml = '<a href="' + url + '" class="c-linkTile__item icon-hidden" data-group="' + this.F1a + ' '+ this.F1b + ' '+ this.F1c + ' '+ this.F1d + ' '+ this.F1e + '" target="' + window + '">' +
