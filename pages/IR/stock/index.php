...
<title>Stock &amp; Corporate Bonds | Global | Ricoh</title>
...
<meta property="og:title" content="Stock &amp; Corporate Bonds | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/IR/stock">
...
<a href="../">Investor Relations</a>
                                    ...
                                    <span>Stock &amp; Corporate Bonds</span>
                                </li>
                </ul>
            </div>
        </div>
...
<section class="c-section " id="section01">
  ...
  <div class="c-linkTile__inner">
    <!-- タイトルのみの場合 ここから -->
    <a href="stock-information/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Stock Information</span>
          </div>
        </div>
      </div>
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="ratings/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Corporate Bonds and Ratings
            </span>
          </div>
        </div>
      </div>
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="shareholder-returns/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="chart/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Stock Price Charts</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
