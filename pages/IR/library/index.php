...
<title>IR Library | Global | Ricoh</title>
...
<meta property="og:title" content="IR Library | Global | Ricoh">
...
<meta property="og:url" content="__RH_BASE__/IR/library">
...
<section class="c-section " id="section01">
  ...
  <div class="c-linkTile__inner">
    <!-- タイトルのみの場合 ここから -->
    <a href="../events/earning/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="financial-results/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Financial Results</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="securities-report/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../../about/integrated-report/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="faq/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
