...
<title>Financial Highlights | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Ricoh Investor Relations.">
<meta property="og:title" content="Financial Highlights | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/IR/library/selected-consolidated-financial-data">
...
<script>document.addEventListener('DOMContentLoaded', function () { const iframeElement = document.getElementById('iframe-04'); if (!iframeElement) return; iframeElement.addEventListener('load', function() { EurolandToolIntegrationObject.set(iframeElement); }); });</script>
<script type="text/javascript" src="/ricoh-clone/ricoh_offline/assets/settleinfo.ir-service.net/Company/7752/js/tc_frameget.js" charset="utf-8"></script>
  ...
  <li class="c-globalNav__item" data-drawer-button="03">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="03" id="globalNavDrawerControlsId-03" style="left: -21.9531px;">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">Financial Highlights</span></a></li>
        ...
        <div class="c-link-a-list">
          <div class="c-link-a-list__inner">
            <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/IR/data/datasheet/quaterly_data_e.xlsx/" class="c-link-a c-link-a--download icon-hidden">
              <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/download-primary-color" alt="Download">
              <span class="c-link-a__text">Historical Data Sheet [XLS]</span>
            </a>
          </div>
        </div>
      </div>
