...
<meta property="og:url" content="__RH_BASE__/IR/library/faq">
  ...
  <li class="c-globalNav__item" data-drawer-button="03">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="03" id="globalNavDrawerControlsId-03">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">FAQ</span></a></li>
      </ul>
    </div>
  </li>
...
<section class="c-section " id="intro">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">The FAQs regarding Corporate Strategy and Financial Results are posted on the Financial Announcement page.</p><!-- テキストはここを編集 -->
</div>
<!-- 日本語版ここから -->
<div class="c-link-a-list u-mt-8">
  <div class="c-link-a-list__inner">
    <a href="../../events/earning/" class="c-link-a icon-hidden">
      ...
      <span class="c-link-a__text">Financial Announcement</span>
    </a>
  </div>
</div>
<!-- 日本語版ここまで -->
...
<section class="c-ancLink-a">
        ...
        <div class="c-margin-a__inner">
          <ul class="c-ancLink-a__list">
            <li class="c-ancLink-a__item">
              <a href="#section01" class="c-ancLink-a__link">Capital Policy</a>
            </li>
            <li class="c-ancLink-a__item">
              <a href="#section02" class="c-ancLink-a__link">Stock Information</a>
            </li>
            <li class="c-ancLink-a__item">
              <a href="#section03" class="c-ancLink-a__link">Others</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Capital Policy</h2>
                    </div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-accordion c-accordion--border"><!-- ここに.c-accordion--borderクラスを追加することで枠線をつけることができます。。 -->
  <!-- アコーディオンitem1 ここから -->
  <div class="c-accordion__item" data-accordion="item">
    <!-- アコーディオンボタン ここから -->
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          What is your shareholder returns policy? (August 26, 2019)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    <!-- アコーディオン内コンテンツ ここまで -->
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
Our policy is as follows: "We believe it is important to increase shareholder returns through sustainable growth that yields medium to long-term stock price increases and stable dividends. We will make effort to raise the total return ratio to 50% gradually. With regard to dividend, we are continuously working to increase stable dividend reflecting improvement of performance. In addition, we will repurchase shares flexibly, with taking various business environment into consideration, by utilizing surplus cash generated from improving capital profitability."<br>
Please click following link for detailed information.<br>
    <a href="../../stock/shareholder-returns/" class="c-link-a icon-hidden u-mt-8">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Shareholder Returns</span>
    </a>
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
  ...
  <!-- アコーディオンitem1 ここまで -->
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Stock Information</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          When was stock made available to the public? And, when was the stock first listed on the Tokyo Stock Exchange? (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
The stock was available on Tokyo Stock Exchange in May, 1949. And the stock was first listed on Tokyo Stock Exchange in October, 1961.
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
  </div>
...
<div class="c-accordion c-accordion--border"><!-- ここに.c-accordion--borderクラスを追加することで枠線をつけることができます。。 -->
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          Which Stock Exchanges is Ricoh Company, Ltd. listed on? (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
The Company is listed on Tokyo Stock Exchange.
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
  </div>
...
<div class="c-accordion c-accordion--border"><!-- ここに.c-accordion--borderクラスを追加することで枠線をつけることができます。。 -->
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          What is Ricoh's stock code of Tokyo Stock Exchange? (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
The Company's stock code is 7752.
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
  </div>
  <!-- アコーディオンitem1 ここまで -->
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Others</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          When was Ricoh Company, Ltd. established? (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
The Company was established as Riken Kankoshi Co., Ltd. on February 6, 1936. And its name was changed to Ricoh Company, Ltd. on April 1, 1963.
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
  </div>
...
<div class="c-accordion c-accordion--border"><!-- ここに.c-accordion--borderクラスを追加することで枠線をつけることができます。。 -->
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          Where can I find the latest financial results? (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
Click the following link to view the financial results.<br>
    <a href="../../events/earning/" class="c-link-a icon-hidden u-mt-8">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Financial Announcement</span>
    </a>
      </p>
...
<div class="c-accordion c-accordion--border"><!-- ここに.c-accordion--borderクラスを追加することで枠線をつけることができます。。 -->
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          I want to see past sales and profit figures. (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
Click the following link to view the financial results.<br>
    <a href="../../finance/selected-consolidated-financial-data/" class="c-link-a icon-hidden u-mt-8">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Selected Consolidated Financial Data</span>
    </a>
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
...
<div class="c-accordion c-accordion--border"><!-- ここに.c-accordion--borderクラスを追加することで枠線をつけることができます。。 -->
  ...
  <div class="c-accordion__item" data-accordion="item">
    ...
    <div class="c-accordion__cell">
      <h3 class="c-accordion__text">
        <button data-accordion="trigger" aria-expanded="false" aria-controls="dummyAccordionControlsId-15" class="u-fz-16">
          Where can I learn more about Ricoh's environmental activities? (December 25, 2018)
        </button>
      </h3>
    </div>
    <!-- アコーディオンボタン ここまで -->
    ...
    <div class="c-accordion__cell" data-accordion="inner" id="dummyAccordionControlsId-15">
      <p class="c-accordion__text">
Click the following link for detailed information on the Ricoh's environmental activities.<br>
    <a href="../../../sustainability/environment/" class="c-link-a icon-hidden u-mt-8">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Environment</span>
    </a>
      </p>
    </div>
    <!-- アコーディオン内コンテンツ ここまで -->
