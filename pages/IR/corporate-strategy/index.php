...
<title>Corporate Strategy | Global | Ricoh</title>
...
<meta property="og:title" content="Corporate Strategy | Global | Ricoh">
    <meta property="og:image" content="__RH_BASE__/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/og-image.webp?rev=549e30934785489fbd556ee2e4c3b238&sc_lang=ja-JP&hash=4FF6DA9CDEA7D90E4BB039F80C87402F">
...
<meta property="og:url" content="__RH_BASE__/IR/corporate-strategy">
...
<section class="c-section " id="section01">
  ...
  <div class="c-linkTile__inner">
    <!-- タイトルのみの場合 ここから -->
    <a href="../../about/to-our-stakeholders/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">To Our Stakeholders</span>
          </div>
        </div>
      </div>
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../events/investors-meeting/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Mid-term Strategy</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../stock/shareholder-returns/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Shareholder Returns</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../../sustainability/governance/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Corporate Governance</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../../sustainability/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
