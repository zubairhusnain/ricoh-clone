...
<title>Shareholder Returns | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Ricoh Investor Relations.">
<meta property="og:title" content="Shareholder Returns | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/IR/stock/shareholder-returns">
...
<link rel="canonical" href="../stock/shareholder-returns/">
...
<script>document.addEventListener('DOMContentLoaded', function () { const iframeElement = document.getElementById('iframe-03'); if (!iframeElement) return; iframeElement.addEventListener('load', function() { EurolandToolIntegrationObject.set(iframeElement); }); });</script>
</head>
<body>
    <div id="wrapper">
...
<section class="c-section " id="section01">
  ...
  <h2 class="c-h2-a__text">Shareholder Returns Policy</h2>
</div>
    </div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-text-a">
  <p class="c-text-a__text">We believe it is important to increase shareholder returns through sustainable growth that yields medium to long-term stock price increases and stable dividends. We will make effort to raise the total return ratio to 50% gradually. With regard to dividend, we are continuously working to increase stable dividend reflecting improvement of performance. In addition, we will repurchase shares flexibly, with taking various business environment into consideration, by utilizing surplus cash generated from improving capital profitability.</p><!-- テキストはここを編集 -->
</div>
                            </div>
                                            </div>
                </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-h2-a u-align-left">
  <h2 class="c-h2-a__text">Repurchase of Shares</h2>
</div>
    </div>
    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
	...
	<table>
	  ...
	  <tbody>
		...
		<tr>
			...
			<td class="u-align-center">Off-Auction Own Share Repurchase Trading (ToSTNeT-3)</td>
			<td class="u-align-right">17,256 thousand shares</td>
			<td class="u-align-right">30 billion yen</td>
			<td>
	<div class="c-link-a-list">
	  <div class="c-link-a-list__inner">
		<a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2024/pdf/1203_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		  <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		  <span class="c-link-a__text">Announcement regarding the results of share repurchase through Off-Auction Own Share Repurchase Trading (ToSTNeT-3) and treasury shares retirement [PDF]</span>
		</a>
	  </div>
	</div>
			</td>
		...
		<!-- 行1 ここから -->
		<tr>
		  <td>February 7, 2024 – August 30, 2024</td>
		  <td class="u-align-center">Purchase on the Tokyo Stock Exchange</td>
		  <td class="u-align-right">22,533 thousand shares</td>
		  <td class="u-align-right">30 billion yen</td>
		  <td>
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2024/pdf/0902_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Ricoh Completes Share Repurchase Program [PDF]</span>
	  </a>
	</div>
  </div>
		  </td>
		...
		<!-- 行2 ここから -->
		<tr>
		  <td>May 11, 2022 - September 22, 2022</td>
		  <td class="u-align-center">Purchase on the Tokyo Stock Exchange</td>
		  <td class="u-align-right">27,946 thousand shares</td>
		  <td class="u-align-right">30 billion yen</td>
		  <td>
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2022/pdf/0928_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Ricoh Completes Share Repurchase Program [PDF]</span>
	  </a>
	</div>
		...
		<!-- 行3 ここから -->
		<tr>
		  <td>March 4, 2021 – December 8, 2021</td>
		  <td class="u-align-center">Purchase on the Tokyo Stock Exchange</td>
		  <td class="u-align-right">87,444 thousand shares</td>
		  <td class="u-align-right">100 billion yen</td>
		  <td>
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2021/pdf/1210_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Ricoh Completes Share Repurchase Program [PDF]</span>
	  </a>
	</div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-h2-a u-align-left">
  <h2 class="c-h2-a__text">Retirement of Treasury Shares</h2>
</div>
    </div>
    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
	...
	<table>
	  ...
	  <thead>
		<tr>
		  ...
		  <th>Type of shares to be retired</th>
		  <th>Number of shares retired</th>
		  <th>Release</th>
		</tr>
	  </thead>
	  <!-- タイトル行 ここまで -->
	  ...
	  <!-- 行1 ここから -->
		<tr>
		  ...
		  <td class="u-align-center">Shares of common stock of RICOH</td>
		  <td class="u-align-right">17,256 thousand shares</td>
		  <td>
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2025/pdf/0131_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Announcement Regarding Retirement of Treasury Shares Completion [PDF]</span>
	  </a>
	</div>
  </div>
		  </td>
  ...
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2024/pdf/0930_2.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Announcement Regarding Retirement of Treasury Shares Completion [PDF]</span>
	  </a>
	</div>
  ...
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2022/pdf/1031_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Announcement Regarding Retirement of Treasury Shares Completion [PDF]</span>
	  </a>
	</div>
		...
		<tr>
		  ...
		  <td class="u-align-center">Shares of common stock of RICOH</td>
		  <td class="u-align-right">107,444 thousand shares</td>
		  <td>
  <div class="c-link-a-list">
	<div class="c-link-a-list__inner">
	  <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/release/2022/pdf/0228_1.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
		<img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
		<span class="c-link-a__text">Ricoh Retires Treasury Shares Pursuant to Article 178 of Companies Act [PDF]</span>
	  </a>
	</div>
  </div>
		  </td>
