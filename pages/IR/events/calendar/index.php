...
<title>Event Calendar | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Ricoh Investor Relations.">
<meta property="og:title" content="Event Calendar | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/IR/events/calendar">
  ...
  <li class="c-globalNav__item" data-drawer-button="02">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="02" id="globalNavDrawerControlsId-02">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">Event Calendar</span></a></li>
      </ul>
    </div>
  </li>
...
<section class="c-section " id="section01">
  ...
  <table>
    ...
    <tbody>
      <!-- 行1 ここから -->
      <tr>
        <th class="u-align-left">Early in May</th>
        <td>Full Year Financial Announcement</td>
      </tr>
      <!-- 行1 ここまで -->
      <!-- 行2 ここから -->
      <tr>
        <th class="u-align-left">End of June</th>
        <td>General Meeting</td>
      </tr>
      <!-- 行2 ここまで -->
      <!-- 行3 ここから -->
      <tr>
        <th class="u-align-left">Early in August</th>
        <td>1st Quarter Financial Announcement</td>
      </tr>
      <!-- 行3 ここまで -->
      <!-- 行4 ここから -->
      <tr>
        <th class="u-align-left">Early in November</th>
        <td>2nd Quarter Financial Announcement</td>
      </tr>
      <!-- 行4 ここまで -->
      <!-- 行5 ここから -->
      <tr>
        <th class="u-align-left">Early in February</th>
        <td>3rd Quarter Financial Announcement</td>
      </tr>
      <!-- 行5 ここまで -->
    </tbody>
  </table>
...
<div class="c-text-a">
  <p class="c-text-a__text">The each date of financial announcement will be announced on top page of IR site. Schedule may change without notice.</p><!-- テキストはここを編集 -->
</div>

<!-- 英語版ここから -->
<div class="c-link-a-list">
  <div class="c-link-a-list__inner">
    <a href="../earning/" class="c-link-a icon-hidden">
      ...
      <span class="c-link-a__text">See past IR Presentations</span>
    </a>
  </div>
</div>
<!-- 英語版ここまで -->            </div>
