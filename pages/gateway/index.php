...
<body>
    ...
    <div class="gl-header_inner">
        <div class="gl-header_logo">
            <a href="../"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_g_header_footer/img/logo/logo.svg" alt="" width="125" height="43"></a>
        </div>
        ...
        <div class="gl-header_menu">
            <nav class="gl-menu js-global-menu" data-label="Menu" aria-label="Main navigation">
                <div class="gl-menu_content fn-menu_hamburger-menu">
                                                            <a class="hide" href="#contents"></a>
                    <span class="hide"></span>
                </div>

                <template class="fn-menu_tpl-hamburger">
                    <button class="gl-menu_toggle-btn" data-alt-open="Open" data-alt-close="Close"><span class="hide"></span></button>
                </template>
...
<div class="c-container">
    ...
    <div class="c-margin-b c-margin-b--large">
        <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/gateway/img/index_world_map.webp" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/gateway/img/index_world_map.webp&quot;);">
        </div>
...
<div class="fxb-section"></div>
    <div class="fxb-section">
<section class="c-ancLink-a">
    <div class="c-margin-a">
        <div class="c-margin-a__inner">
            <ul class="c-ancLink-a__list">
                <li class="c-ancLink-a__item"><a href="#americas" class="c-ancLink-a__link">Americas</a></li>
                <li class="c-ancLink-a__item"><a href="#europe" class="c-ancLink-a__link">Europe/Middle East/Africa</a></li>
                <li class="c-ancLink-a__item"><a href="#asia" class="c-ancLink-a__link">Asia Pacific</a></li>
                <li class="c-ancLink-a__item"><a href="#global" class="c-ancLink-a__link">Global</a></li>
            </ul>
        </div>
    </div>
</section><section class="c-section " id="americas">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Americas</h2>
                    </div>
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Other Country</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
    <p class="c-text-a__text">
        If the country that you are looking for is not on the list above, please go to the Regional Headquarter's website.
    </p>
</div>
<div class="c-linkColumn c-linkColumn--col4 u-mt-24">
    <div class="c-linkColumn__inner">
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">For Thermal Media Products</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-linkColumn c-linkColumn--col4">
...
</section><section class="c-section c-section--gray" id="europe">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Europe/Middle East/Africa</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
...
</section><section class="c-section " id="asia">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Asia Pacific</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Other Country/Area</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
    <p class="c-text-a__text">
        If your country/area is not on the list above, please go to the Regional Headquarter's website.
    </p>
</div>
<div class="c-linkColumn c-linkColumn--col4 u-mt-24">
    <div class="c-linkColumn__inner">
...
</section><section class="c-section c-section--gray" id="global">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Global</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
    ...
    <div class="c-linkColumn__inner">
        ...
        <div class="c-linkColumn__item">
            <a href="../" class="c-link-a icon-hidden">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
                <span class="c-link-a__text">Ricoh Global - English</span>
            </a>
        </div>
