        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Announcement Regarding Share Repurchase and Retirement of Treasury Shares</span>
                            </li>
                </ul>
            </div>
        </div>
        ...
        <div class="c-margin-b__inner">
            <h1 class="c-releaseHeader__title">
                    <span class="c-newsIcon">News Release</span>
                                    <span class="c-releaseHeader__title__main">Announcement Regarding Share Repurchase and Retirement of Treasury Shares</span>
                            </h1>
                <div class="c-releaseHeader__date">2026.05.12</div>
                                        <div class="c-releaseHeader__author"><div class="c-releaseHeader__author">Ricoh Company, Ltd.</div></div>
        </div>
    </div>
</section>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-text-a">
  <p class="c-text-a__text">Ricoh Company, Ltd., announces that its Board of Directors resolved in a meeting today to repurchase some shares in accordance with Article 156 of the Companies Act of Japan and pursuant to Article 165, Paragraph 3, of the Companies Act. The Board also decided to retire treasury shares under Article 178 of the Companies Act.</p>
  <p class="c-text-a__text">For details, please see the link below.</p>
</div>
<div class="c-h3-a">
  <h2 class="c-h3-a__text">For full version in PDF format</h2>
</div>
<div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/release/2026/pdf/0512_1.pdf" class="c-link-a c-link-a--pdf icon-hidden" target="ricoh">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
      <span class="c-link-a__text">Announcement Regarding Share Repurchase and Retirement of Treasury Shares</span>
    </a>
  </div>
</div>
                            </div>
