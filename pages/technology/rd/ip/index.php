        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Initiatives in Intellectual Property</span>
                            </li>
                </ul>
            </div>
        </div>
...
<div class="c-container">
        ...
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__container">
                    <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/ip/img/main.webp" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/ip/img/main.webp&quot;);"></div>
                </div>
            <div class="c-margin-b__inner">
                <div class="c-mv__inner">
                    <div class="c-mv__balloon">
                        ...
                        <h1 class="c-h1-a">
                                <span class="c-mv__text">Sophisticated utilization of IP keeps Ricoh at the forefront of technology.</span>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text u-font-bold">The Ricoh Group sees intellectual property, the fruits of technical development, as an important management asset. We work to acquire and exploit intellectual property to develop and protect our business, while encouraging the creation of valuable intellectual property based on a business strategy and a technological strategy.</p>
</div>
    </div>
...
</section><section class="c-ancLink-a u-pt-0">
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item"><a href="#section1" class="c-ancLink-a__link">Status of intellectual property acquisition</a></li>
        <li class="c-ancLink-a__item"><a href="#section2" class="c-ancLink-a__link">Global intellectual property framework</a></li>
        <li class="c-ancLink-a__item"><a href="#section3" class="c-ancLink-a__link">Our efforts to improve organizational ability for supporting intellectual property activity</a></li>
      </ul>
    </div>
  </div>
</section><section class="c-section " id="section1">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Status of intellectual property acquisition</h2>
                    </div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-text-a">
  <p class="c-text-a__text">In recent years, Ricoh has increased the number of foreign patent applications while maintaining its position in the top ten applicants for Japanese patents.</p>
  <p class="c-text-a__text">1,218 patent applications were published in Japan in fiscal 2024. For the number of maintained patent rights, Ricoh has more than 12,000 patents in Japan and 17,000 or more patents overseas, 30,667 patents in total (Table 1) at the end of March, 2025.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">We have been actively continuing to acquire patents worldwide in accordance with business and technological strategies, such as reinforcing our position in our core business domain, globalizing our business through deployment in emerging markets, and expanding our business domain through new business (Figure 1).</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Furthermore, we are conducting a review of maintained patent rights by assessing future market and business conditions and determining whether to abandon any unnecessary patent rights.</p>
</div>
<div class="c-table c-table--scrollX-sp c-table--sell-thin u-mb-40">
  <table data-sp-table-width="640">
    <caption class="u-align-left u-pb-16">Table 1: Number of Ricoh's patents</caption>
    <colgroup>
    ...
    <tbody>
      <tr>
        <th>Number of publication of Unexamined Japanese patent applications</th>
        <td>1,218 (in fiscal 2024)</td>
      </tr>
      <tr>
        <th>Number of maintained Japanese patent rights</th>
        <td>12,903 (as of the end of March, 2025)</td>
      </tr>
      <tr>
        <th>Number of maintained overseas patent rights</th>
        <td>17,764 (as of the end of March, 2025)</td>
      </tr>
    </tbody>
  </table>
</div>
                                    ...
                                    <figure class="c-linkCard__image">
                                            <div class="c-linkCard__imageInner c-linkCard__imageInner--noRatio">
                                                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/ip/img/img01.webp" alt="">
                                            </div>
                                        <figcaption class="c-caption">
                                            <div class="c-text-a c-text-a--thin">
                                                <p class="c-text-a__text">Figure 1: Number of registered patents in Japan and overseas</p>
                                            </div>
                                        </figcaption>
                                    </figure>
                            </div>
...
</section><section class="c-section " id="section2">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Global intellectual property framework</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">Ricoh’s intellectual property activities began with a camera patent application in 1947. The patent management section was first organized in 1958 when the first person dedicated to patents was assigned. The intellectual property department has then expanded and strengthened as Ricoh business grew exponentially over the intervening decades.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Our Intellectual Property Center comprises the Intellectual Property Development Department and the Intellectual Property Strategy Department. These departments are respectively tasked with patent prosecution, external affairs and licensing.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Intellectual property workers keep close contact with their colleagues in research and development so as to apply for patents and establish rights as soon as possible.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">To acquire valuable intellectual property suitable for individual markets timely and speedily, we have staffed an intellectual property organization in major R&amp;D centers. By doing so, we have the capability to carry out on-site based intellectual property activities with no time lag.</p>
</div>
                            </div>
                                            </div>
                </div>
...
</section><section class="c-section " id="section3">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Our efforts to improve organizational ability for supporting intellectual property activity</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
