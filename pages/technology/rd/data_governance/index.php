...
<title>Ricoh Group Data Governance | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Data Utilization at the Ricoh Group: Creating the Future Together with Customers">
<meta property="og:title" content="Ricoh Group Data Governance | Global | Ricoh">
    ...
    <meta property="og:description" content="Data Utilization at the Ricoh Group: Creating the Future Together with Customers">
<meta property="og:url" content="https://www.ricoh.com/technology/rd/data_governance">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Ricoh Group Data Governance</span>
                            </li>
                </ul>
            </div>
        </div>
...
<div class="c-container">
        ...
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__container">
                    <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/data_governance/img/main.webp" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/data_governance/img/main.webp&quot;);"></div>
                </div>
            <div class="c-margin-b__inner">
                <div class="c-mv__inner">
                    <div class="c-mv__balloon">
                        ...
                        <h1 class="c-h1-a">
                                <span class="c-mv__text">Data Utilization at the Ricoh Group: Creating the Future Together with Customers</span>
                            Ricoh Group Data Governance
                        </h1>
                                    </div>
            </div>
        </div>
  ...
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item"><a href="#section01" class="c-ancLink-a__link">Introduction</a></li>
        <li class="c-ancLink-a__item"><a href="#section02" class="c-ancLink-a__link">Initiatives to Support Safety and Trust</a></li>
        <li class="c-ancLink-a__item"><a href="#section03" class="c-ancLink-a__link">Governance and Implementation Structure</a></li>
        <li class="c-ancLink-a__item"><a href="#related" class="c-ancLink-a__link">Related Information</a></li>
      </ul>
    </div>
  </div>
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">The Evolution of Technology and the Nature of Trust</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">As generative AI and other innovative digital technologies continue to evolve at a rapid pace, companies are increasingly being held accountable not only for the safety and convenience of their digital services, but also for their impact on the people who use them.</p>
  <p class="c-text-a__text">In addition to the safe management of data entrusted to us by our customers, the Ricoh Group places importance on designs and operations that take ethical, legal, and social issues (ELSI) into consideration.</p>
</div>
                            </div>
                                            </div>
                </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Initiatives to Support Safety and Trust</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Ricoh Group Data Governance Policy</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">The Ricoh Group is committed to the responsible utilization of data, enabling customers to take advantage of digital technologies with confidence and peace of mind.</p>
  <p class="c-text-a__text">As a foundational guideline for this purpose, the Ricoh Group has established the Ricoh Group Data Governance Policy.</p>
</div>
                            </div>
                                            </div>
                </div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-h4-a">
  <h4 class="c-h4-a__text">1. Data Utilization</h4>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">The Ricoh Group regards data as an important asset that contributes to the creation of new customer value and actively utilizes it through cross-organizational sharing and collaboration, including the use of advanced technologies such as AI.<br>When utilizing data, the Ricoh Group complies with the principles outlined in Sections 2 through 4 below.</p>
</div>
<div class="c-h4-a">
  <h4 class="c-h4-a__text">2. Data Security and Privacy Protection</h4>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Ensuring the security and safety of customer information is one of the Ricoh Group's highest priorities. The Ricoh Group complies with applicable laws and regulations, as well as its Data Privacy Policy, and places top priority on ensuring the confidentiality, integrity, and availability of data.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">To achieve this, appropriate security measures—including encryption, access control, and vulnerability management—are applied and continuously improved. When handling personal information, the Ricoh Group complies with all applicable laws and regulations and operates with a strong emphasis on privacy protection.</p>
</div>
<div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="../../../security/" class="c-link-a icon-hidden">
      ...
      <span class="c-link-a__text">Click here for more information about the Ricoh Group's information security</span>
    </a>
  </div>
</div>
<div class="c-attention-a">
  <ul class="c-attention-a__list">
    <li class="c-attention-a__item">
      ...
      <div class="c-attention-a__text">The Data Privacy Policy defines the rules for protecting data (information), while the Data Governance Policy defines the rules for utilizing data.</div>
    </li>
  </ul>
</div>
<div class="c-h4-a">
  <h4 class="c-h4-a__text">3. Assurance of Data Quality</h4>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">The Ricoh Group has established quality control processes to maintain the accuracy, consistency, and integrity of data. An appropriate data environment is maintained through validation at the time of data entry and the periodic cleansing of data.</p>
</div>
<div class="c-h4-a">
  <h4 class="c-h4-a__text">4. Compliance and the Technology Ethics Charter</h4>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">The Ricoh Group complies with all applicable laws and regulations in Japan and overseas and observes compliance across all processes related to the acquisition, use, and storage of data.</p>
</div>
<div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="../../../sustainability/governance/compliance/" class="c-link-a icon-hidden">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Click here for more information about the Ricoh Group's compliance</span>
    </a>
  </div>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">In accordance with the Technology Ethics Charter, the Ricoh Group conducts its activities ethically and honestly to ensure that customers and users do not experience concerns, dissatisfaction, or disadvantage.</p>
</div>
<div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="../technology_ethics/" class="c-link-a icon-hidden">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Click here for more information about the Ricoh Group's Technology Ethics Charter</span>
    </a>
  </div>
</div>
                            </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Governance and Implementation Structure</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">The Ricoh Group has established the Data Governance Subcommittee under the DXO Committee, led by the Chief Technology Officer (CTO), and works to manage and mitigate data-related risks.</p>
  <p class="c-text-a__text">This subcommittee consists of members selected from each business unit and Group headquarters, and its activities are rolled out across all domestic and overseas Group companies.<sup>*</sup></p>
</div>
<div class="c-attention-a u-pb-40">
  <ul class="c-attention-a__list">
    <li class="c-attention-a__item">
      <div class="c-attention-a__marker"><span>*</span></div>
      <div class="c-attention-a__text">Rollout to individual Group companies is conducted by the supervising organization.</div>
    </li>
  </ul>
</div>
                            </div>
                                    ...
                                    <figure class="c-linkCard__image">
                                            <div class="c-linkCard__imageInner c-linkCard__imageInner--noRatio">
                                                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/data_governance/img/image.webp" alt="">
                                            </div>
                                        <figcaption class="c-caption">
                                            <div class="c-text-a c-text-a--thin">
                                                <p class="c-text-a__text"><span class="u-dsp-b u-align-center">Governance and Implementation Structure (as of December 23, 2025)</span></p>
                                            </div>
                                        </figcaption>
                                    </figure>
                            </div>
  ...
  <div class="c-linkTile__inner">
    <a href="../../../sustainability/governance/risk/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
    ...
    <a href="../../../security/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Information Security</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    </a>
    <a href="../technology_ethics/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Ricoh Group Technology Ethics</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
