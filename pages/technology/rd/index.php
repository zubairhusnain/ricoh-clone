...
<section class="c-section " id="section">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Concept and Approach</h2>
                    </div>
                <div class="c-linkTile c-linkTile--col2">
  <div class="c-linkTile__inner">
    <a href="message/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Message from the Chief Technology Officer</span>
          </div>
        </div>
        <div class="c-text-b">
          <p class="c-text-b__text">Using Ricoh's unique technologies to create innovation with customers</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/rd/index/img/tmb-message" alt="">
      </div>
    </a>
    <a href="../ai/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
        ...
        <div class="c-text-b">
          <p class="c-text-b__text">Ricoh offers digital services that support creativity and transforms the workplace</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/rd/index/img/tmb-ai" alt="">
      </div>
    </a>
    <a href="../inkjet/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
        ...
        <div class="c-text-b">
          <p class="c-text-b__text">Pushing the boundaries of inkjet to open new worlds</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/rd/index/img/tmb-inkjet" alt="">
      </div>
    </a>
    <a href="technology_ethics/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
        ...
        <div class="c-text-b">
          <p class="c-text-b__text">Working to mitigate the risks inherent in digital services' development, social implementation, and operation.</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/rd/index/img/tmb-technology_ethics" alt="">
      </div>
    </a>
    <a href="data_governance/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Ricoh Group Data Governance</span>
          </div>
        </div>
        <div class="c-text-b">
          <p class="c-text-b__text">Data Utilization at the Ricoh Group: Creating the Future Together with Customers</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/index/img/tmb-data_governance.webp" alt="">
      </div>
    </a>
    <a href="ip/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Initiatives in Intellectual Property</span>
          </div>
        </div>
        <div class="c-text-b">
          <p class="c-text-b__text">Sophisticated utilization of IP keeps Ricoh at the forefront of technology.</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/index/img/tmb-ip.webp" alt="">
      </div>
    </a>
    <a href="../40days_challenge/" class="c-linkTile__item">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">NHK's “NIGHT OF THE MAKAIZO SOCIETY”<br>A close look at Ricoh developed machine</span>
          </div>
        </div>
        <div class="c-text-b">
          <p class="c-text-b__text">“DVD player bowling” and “penguin long jump roping”</p>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/rd/index/img/tmb-40days_challenge" alt="">
      </div>
    </a>
  </div>
</div>            </div>
