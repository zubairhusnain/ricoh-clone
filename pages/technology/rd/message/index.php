...
<title>Message from the Chief Technology Officer | Global | Ricoh</title>
<meta property="og:title" content="Message from the Chief Technology Officer | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/technology/rd/message">
...
@media screen and (min-width: 640.02px) {
  #section .c-linkCard.c-linkCard--col2 {
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Message from the Chief Technology Officer</span>
                            </li>
                </ul>
            </div>
        </div>
...
<section class="c-section " id="section">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Using Ricoh's unique technologies to create innovation with customers</h2>
                    </div>
                        ...
                        <div class="c-linkCard__inner">
                                        ...
                                        <div class="c-linkCard__image">
                                                <div class="c-linkCard__imageInner c-linkCard__imageInner--noRatio">
                                                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/message/img/CTO.jpg" alt="Yasuyuki Nomizu CTO (Chief Technology Officer)">
                                                </div>
                                        </div>
                                </div>
                        </div>
  ...
  <div class="c-linkCard c-linkCard--col3">
    <div class="c-linkCard__item">
      <a href="../../ai/" class="c-linkCard__link">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">Optimal Support for Your Work Using AI
              <p class="c-text-a__text u-fz-14">Ricoh offers digital services that support creativity and transforms the workplace</p>
            </div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/message/img/bnr-ai" alt="">
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="../../inkjet/" class="c-linkCard__link">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">The Expansion of Ricoh's Inkjet Technology
              <p class="c-text-a__text u-fz-14">Pushing the boundaries of inkjet to open new worlds</p>
            </div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/rd/message/img/bnr-inkjet" alt="">
          </div>
        </div>
      </a>
    </div>
