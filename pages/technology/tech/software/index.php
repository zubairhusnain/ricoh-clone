...
<title>Technology by field - Software | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Optimizing Diverse Information">
<meta property="og:title" content="Technology by field - Software | Global | Ricoh">
    ...
    <meta property="og:description" content="Optimizing Diverse Information">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/software">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by field - Software</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="F3a F3b F3c F3d F3e">All</button></li>
  <li><button class="tabListDetail" data-group="F3c">AI (Artificial Intelligence)</button></li>
  <li><button class="tabListDetail" data-group="F3b">Network</button></li>
  <li><button class="tabListDetail" data-group="F3a">IoT (Internet of Things)</button></li>
  <li><button class="tabListDetail" data-group="F3d">Sensing</button></li>
  <li><button class="tabListDetail" data-group="F3e">Security</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Software</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/software/js/software.js" defer=""></script>
