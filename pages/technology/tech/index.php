...
<section class="c-ancLink-a">
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item"><a href="#field" class="c-ancLink-a__link">Technology by Field</a></li>
        <li class="c-ancLink-a__item"><a href="#product" class="c-ancLink-a__link">Technology by Product Type</a></li>
        <li class="c-ancLink-a__item"><a href="#latest" class="c-ancLink-a__link">Latest Content</a></li>
      </ul>
    </div>
  </div>
</section><section class="c-section " id="field">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Technology by Field</h2>
                    </div>
  ...
  <div class="c-linkCard c-linkCard--col3"><!-- c-linkCard--colXクラスの数値を変更することで1-5カラムまで変更することができます。 -->
    ...
    <div class="c-linkCard__item">
      <a href="software/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb03.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Software</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Optimizing Diverse Information</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- item2 ここから -->
    <div class="c-linkCard__item">
      <a href="printing/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb01.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Printing</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Diverse Applications of Printing Technology</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- item3 ここから -->
    <div class="c-linkCard__item">
      <a href="optics_image/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb02.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Optics / Image Processing</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Optics / Image Processing</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="c-linkCard__item">
      <a href="environment/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb04.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Environment</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Zero-carbon / Circular Society</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- item5 ここから -->
    <div class="c-linkCard__item">
      <a href="production/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb05.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Production / Analysis / Control</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Manufacturing Efficiency</p>
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- item6 ここから -->
    <div class="c-linkCard__item">
      <a href="material_device/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb06.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Materials / Devices</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Innovative Features</p>
          </div>
        </div>
      </a>
    </div>
...
</section><section class="c-section c-section--gray" id="product">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Technology by Product Type</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
  ...
  <div class="c-linkCard c-linkCard--col3">
    <div class="c-linkCard__item">
      <a href="workplace_services/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb08.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Workplace Services</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Transforming how we work with Process Automation, Workplace Experience, and more</p>
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="office_printing/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb07.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Office Printing</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Imaging equipment including MFPs, printers</p>
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="commercial_printing/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb09.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Commercial Printing</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Digital printing products and services for the printing industry</p>
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="industrial_printing/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb10.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Industrial Printing</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Industrial inkjet printheads, inkjet ink, printers to print on anything</p>
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="industrial_products/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb11.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Industrial Products</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Cameras, optical elements and thermal media that use optical and image processing technologies</p>
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="solutions/" class="c-linkCard__link">
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/technology/tech/img/thumb12.webp" alt="">
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Solutions for Society</h3>
          </div>
        </div>
        <div class="c-linkCard__text">
          <div class="c-text-a c-text-a--thin">
            <p class="c-text-a__text c-linkCard__hoverRed">Spherical cameras, healthcare, eco solutions and more</p>
          </div>
        </div>
      </a>
    </div>
...
</section><section class="c-section " id="latest">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Latest Content</h2>
                    </div>
                <div id="content">
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/js/latest_v2" defer=""></script>
