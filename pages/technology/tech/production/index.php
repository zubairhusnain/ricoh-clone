...
<title>Technology by field - Production / Analysis / Control | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Manufacturing Efficiency">
<meta property="og:title" content="Technology by field - Production / Analysis / Control | Global | Ricoh">
    ...
    <meta property="og:description" content="Manufacturing Efficiency">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/production">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by field - Production / Analysis / Control</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="F5a F5b F5c">All</button></li>
  <li><button class="tabListDetail" data-group="F5a">Production Systems</button></li>
  <li><button class="tabListDetail" data-group="F5b">Analysis / Simulation</button></li>
  <li><button class="tabListDetail" data-group="F5c">Control Systems</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Production / Analysis / Control</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/production/js/production.js" defer=""></script>
