...
<title>Technology by field - Optics / Image Processing | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Optics / Image Processing">
<meta property="og:title" content="Technology by field - Optics / Image Processing | Global | Ricoh">
    ...
    <meta property="og:description" content="Optics / Image Processing">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/optics_image">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by field - Optics / Image Processing</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="F2a F2b F2c F2d F2e">All</button></li>
  <li><button class="tabListDetail" data-group="F2a">Machine Vision</button></li>
  <li><button class="tabListDetail" data-group="F2b">Display / Projection</button></li>
  <li><button class="tabListDetail" data-group="F2c">Image Processing / Analysis</button></li>
  <li><button class="tabListDetail" data-group="F2d">Optical Devices</button></li>
  <!-- <li><button class="tabListDetail" data-group="F2e">Medical Imaging</button></li> -->
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="../printing/" class="c-link-a"><span class="c-link-a__text">Printing</span></a></div>
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Optics / Image Processing</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/optics_image/js/optics_image.js" defer=""></script>
