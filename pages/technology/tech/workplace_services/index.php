...
<title>Technology by product type - Workplace Services | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Transforming how we work with Process Automation, Workplace Experience, and more">
<meta property="og:title" content="Technology by product type - Workplace Services | Global | Ricoh">
    ...
    <meta property="og:description" content="Transforming how we work with Process Automation, Workplace Experience, and more">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/workplace_services">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by product type - Workplace Services</span>
                            </li>
                </ul>
            </div>
        </div>
...
<section class="c-section u-pt-0">
  <div class="f-child">
    <div class="c-margin-b">
      <div class="c-margin-b__inner">
        <div class="c-text-a">
          <p>Transforming how we work with Process Automation, Workplace Experience, and more</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="tabList" data-category="field">
        <li><button class="tabListDetail is-active" data-group="P2a P2b P2c">All</button></li>
        <li><button class="tabListDetail" data-group="P2a">Process Automation</button></li>
        <li><button class="tabListDetail" data-group="P2b">Workplace Experience</button></li>
        <li><button class="tabListDetail" data-group="P2c">AI Solutions</button></li>
      </ul>
    </div>
  </div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Workplace Services</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/workplace_services/js/workplace_services.js" defer=""></script>
