...
<title>Technology by field - Environment | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Zero-carbon / Circular Society">
<meta property="og:title" content="Technology by field - Environment | Global | Ricoh">
    ...
    <meta property="og:description" content="Zero-carbon / Circular Society">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/environment">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by field - Environment</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="F4a F4b F4c F4d">All</button></li>
  <li><button class="tabListDetail" data-group="F4a">Energy Conservation</button></li>
  <li><button class="tabListDetail" data-group="F4b">Energy Creation</button></li>
  <li><button class="tabListDetail" data-group="F4c">Resource Conservation</button></li>
  <li><button class="tabListDetail" data-group="F4d">Pollution Prevention</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Environment</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/environment/js/environment.js" defer=""></script>
