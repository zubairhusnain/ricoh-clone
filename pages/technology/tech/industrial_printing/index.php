...
<title>Technology by product type - Industrial Printing | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Industrial inkjet printheads, inkjet ink, printers to print on anything">
<meta property="og:title" content="Technology by product type - Industrial Printing | Global | Ricoh">
    ...
    <meta property="og:description" content="Industrial inkjet printheads, inkjet ink, printers to print on anything">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/industrial_printing">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by product type - Industrial Printing</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="P4a P4b">All</button></li>
  <li><button class="tabListDetail" data-group="P4a">Inkjet printheads</button></li>
  <li><button class="tabListDetail" data-group="P4b">Ink / supply</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Industrial Printing</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/industrial_printing/js/industrial_printing.js" defer=""></script>
