...
<title>Technology by product type - Commercial Printing | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Digital printing products and services for the printing industry">
<meta property="og:title" content="Technology by product type - Commercial Printing | Global | Ricoh">
    ...
    <meta property="og:description" content="Digital printing products and services for the printing industry">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/commercial_printing">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by product type - Commercial Printing</span>
                            </li>
                </ul>
            </div>
        </div>
...
<section class="c-section u-pt-0">
  <div class="f-child">
    <div class="c-margin-b">
      <div class="c-margin-b__inner">
        <div class="c-text-a">
          <p>Digital printing products and services for the printing industry</p>
        </div>
      </div>
    </div>
  </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="P3a P3b">All</button></li>
  <li><button class="tabListDetail" data-group="P3a">Electrophotographic</button></li>
  <li><button class="tabListDetail" data-group="P3b">Inkjet</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Commercial Printing</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/commercial_printing/js/commercial_printing.js" defer=""></script>
