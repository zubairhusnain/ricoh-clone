...
<title>Technology by field - Materials / Devices | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Innovative Features">
<meta property="og:title" content="Technology by field - Materials / Devices | Global | Ricoh">
    ...
    <meta property="og:description" content="Innovative Features">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/material_device">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by field - Materials / Devices</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="F6a F6b F6c F6d">All</button></li>
  <li><button class="tabListDetail" data-group="F6a">Materials</button></li>
  <li><button class="tabListDetail" data-group="F6b">Precision Machining</button></li>
  <li><button class="tabListDetail" data-group="F6c">Mechanics and Electronics</button></li>
  <li><button class="tabListDetail" data-group="F6d">Devices</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Materials / Devices</span></a></div>
          </div>
        </div>
      </div>
    </div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/material_device/js/material_device.js" defer=""></script>
