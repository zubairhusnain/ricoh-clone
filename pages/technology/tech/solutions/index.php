...
<title>Technology by product type - Solutions for Society | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Spherical cameras, healthcare, eco solutions and more">
<meta property="og:title" content="Technology by product type - Solutions for Society | Global | Ricoh">
    ...
    <meta property="og:description" content="Spherical cameras, healthcare, eco solutions and more">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/solutions">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by product type - Solutions for Society</span>
                            </li>
                </ul>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="P6a P6b P6c P6d">All</button></li>
  <li><button class="tabListDetail" data-group="P6a">Smart Vision</button></li>
  <!-- li><button class="tabListDetail" data-group="P6b">Solutions</button></li -->
  <li><button class="tabListDetail" data-group="P6c">Healthcare</button></li>
  <li><button class="tabListDetail" data-group="P6d">Environment / Energy</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Solutions for Society</span></a></div>
          </div>
        </div>
      </div>
    </div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/solutions/js/solutions.js" defer=""></script>
