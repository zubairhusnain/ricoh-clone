...
<title>Technology by field - Printing | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Printing Diverse Applications of Printing Technology">
<meta property="og:title" content="Technology by field - Printing | Global | Ricoh">
    ...
    <meta property="og:description" content="Printing Diverse Applications of Printing Technology">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/printing">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by field - Printing</span>
                            </li>
                </ul>
            </div>
        </div>
        ...
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <h1 class="c-h1-b__text">
                            <span class="c-h1-b__head">Technology by field</span>
                        Printing
                    </h1>
            </div>
        </div>
...
<section class="c-section u-pt-0">
  <div class="f-child">
    <div class="c-margin-b">
      <div class="c-margin-b__inner">
        <div class="c-text-a">
          <p>Printing Diverse Applications of Printing Technology</p>
        </div>
      </div>
    </div>
  </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="F1a F1b F1c F1d F1e">All</button></li>
  <li><button class="tabListDetail" data-group="F1a">Electrophotographic</button></li>
  <li><button class="tabListDetail" data-group="F1b">Inkjet</button></li>
  <li><button class="tabListDetail" data-group="F1c">Thermal Media</button></li>
  <li><button class="tabListDetail" data-group="F1d">Printed Electronics</button></li>
  <li><button class="tabListDetail" data-group="F1e">Bioprinting</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            <div class="c-linkColumn__item"><a href="../software/" class="c-link-a"><span class="c-link-a__text">Software</span></a></div>
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Printing</span></a></div>
            <div class="c-linkColumn__item"><a href="../optics_image/" class="c-link-a"><span class="c-link-a__text">Optics / Image Processing</span></a></div>
            <div class="c-linkColumn__item"><a href="../environment/" class="c-link-a"><span class="c-link-a__text">Environment</span></a></div>
            <div class="c-linkColumn__item"><a href="../production/" class="c-link-a"><span class="c-link-a__text">Production / Analysis / Control</span></a></div>
            <div class="c-linkColumn__item"><a href="../material_device/" class="c-link-a"><span class="c-link-a__text">Materials / Devices</span></a></div>
          </div>
        </div>
      </div>
    </div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/printing/js/printing.js" defer=""></script>
