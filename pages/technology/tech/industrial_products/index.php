...
<title>Technology by product type - Industrial Products | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Cameras, optical elements and thermal media that use optical and image processing technologies">
<meta property="og:title" content="Technology by product type - Industrial Products | Global | Ricoh">
    ...
    <meta property="og:description" content="Cameras, optical elements and thermal media that use optical and image processing technologies">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/industrial_products">
...
<link rel="stylesheet" type="text/css" media="all" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/css/cmn.css">
...
<button type="button" aria-current="page" class="{269944AA-F9F1-450F-808A-5A0A25693389} gl-menu_link fn-menu_main fn-current is-current" aria-controls="megamenu-5" aria-expanded="false"><span>Technology</span></button>
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                                    ...
                                    <li>
                                        <a href="../">Ricoh's Technology</a>
                                    </li>
                            <li class="act">
                                <span>Technology by product type - Industrial Products</span>
                            </li>
                </ul>
            </div>
        </div>
        ...
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <h1 class="c-h1-b__text">
                            <span class="c-h1-b__head">Technology by product type</span>
                        Industrial Products
                    </h1>
            </div>
        </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="P5a P5b P5c P5c">All</button></li>
  <!-- <li><button class="tabListDetail" data-group="P5a">FA Cameras</button></li> -->
  <!-- <li><button class="tabListDetail" data-group="P5b">Optical Units</button></li> -->
  <li><button class="tabListDetail" data-group="P5c">Thermal Media</button></li>
  <li><button class="tabListDetail" data-group="P5d">Environment</button></li>
</ul>
</div>
</div>
...
<a href="../090_high_power_laser_marker/" class="c-linkTile__item icon-hidden" data-group="  P5c " target="_self" style="display: inline;"><div class="c-linkTile__content"><div class="c-linkTile__heading"><div class="c-text-a c-text-a--thin"><span class="c-text-a__text u-font-bold">192-Ch High-Power Laser Marker</span></div></div><div class="c-text-b"><p class="c-text-b__text">Printing consistent variable data, such as QR codes, at a maximum speed of 300m per min</p></div></div><div class="c-linkTile__image"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/img/090_index" alt=""></div><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt=""></a><a href="../062_laserrewritable/" class="c-linkTile__item icon-hidden" data-group="  P5c P5d" target="_self" style="display: inline;"><div class="c-linkTile__content"><div class="c-linkTile__heading"><div class="c-text-a c-text-a--thin"><span class="c-text-a__text u-font-bold">Rewritable Laser System</span></div></div><div class="c-text-b"><p class="c-text-b__text">A printing process using laser diode allows rewriting to durable</p></div></div><div class="c-linkTile__image"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/img/tm_ph062.jpg" alt=""></div><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt=""></a><a href="../004_rewritable/" class="c-linkTile__item icon-hidden" data-group="  P5c P5d" target="_self" style="display: inline;"><div class="c-linkTile__content"><div class="c-linkTile__heading"><div class="c-text-a c-text-a--thin"><span class="c-text-a__text u-font-bold">Rewritable Recording Technology</span></div></div><div class="c-text-b"><p class="c-text-b__text">Rewritable recording of high quality using a material technology to control coloring and decoloring of dyestuff.</p></div></div><div class="c-linkTile__image"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/img/004_index" alt=""></div><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt=""></a></div>
</div>
</div>            </div>
        </div>
    </div>
</section><section id="localNav" class="c-section c-section--gray">
  <div class="f-child">
    <div class="c-margin-b">
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            <div class="c-linkColumn__item"><a href="../workplace_services/" class="c-link-a"><span class="c-link-a__text">Workplace Services</span></a></div>
            <div class="c-linkColumn__item"><a href="../office_printing/" class="c-link-a"><span class="c-link-a__text">Office Printing</span></a></div>
            <div class="c-linkColumn__item"><a href="../commercial_printing/" class="c-link-a"><span class="c-link-a__text">Commercial Printing</span></a></div>
            <div class="c-linkColumn__item"><a href="../industrial_printing/" class="c-link-a"><span class="c-link-a__text">Industrial Printing</span></a></div>
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Industrial Products</span></a></div>
            <div class="c-linkColumn__item"><a href="../solutions/" class="c-link-a"><span class="c-link-a__text">Solutions for Society</span></a></div>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="gl-footer-link-area-pc_list">
          ...
          <div class="gl-footer-link-area-pc_item">
            ...
            <ul class="gl-footer-link-area-pc_link-list">
              ...
              <li class="gl-footer-link-area-pc_link-item"><a href="../">Ricoh's Technology</a></li>
              </ul>
            </div>
          <div class="gl-footer-link-area-pc_item">
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/industrial_products/js/industrial_products.js" defer=""></script>
