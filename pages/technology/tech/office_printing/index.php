...
<title>Technology by product type - Office Printing | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Imaging equipment including MFPs, printers">
<meta property="og:title" content="Technology by product type - Office Printing | Global | Ricoh">
    ...
    <meta property="og:description" content="Imaging equipment including MFPs, printers">
<meta property="og:url" content="https://www.ricoh.com/technology/tech/office_printing">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Technology by product type - Office Printing</span>
                            </li>
                </ul>
            </div>
        </div>
...
<section class="c-section u-pt-0">
  <div class="f-child">
    <div class="c-margin-b">
      <div class="c-margin-b__inner">
        <div class="c-text-a">
          <p>Imaging equipment including MFPs, printers</p>
        </div>
      </div>
    </div>
  </div>
...
<ul class="tabList" data-category="field">
  <li><button class="tabListDetail is-active" data-group="P1a P1b P1c P1d P1e P1f">All</button></li>
  <li><button class="tabListDetail" data-group="P1a">Printing</button></li>
  <li><button class="tabListDetail" data-group="P1b">Ink / Toner</button></li>
  <li><button class="tabListDetail" data-group="P1c">Network / Security</button></li>
  <li><button class="tabListDetail" data-group="P1d">Control Systems</button></li>
  <li><button class="tabListDetail" data-group="P1e">Environment</button></li>
  <li><button class="tabListDetail" data-group="P1f">Analysis / Simulation</button></li>
</ul>
</div>
</div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkColumn c-linkColumn--col3">
          <div class="c-linkColumn__inner">
            ...
            <div class="c-linkColumn__item"><a href="" class="c-link-a"><span class="c-link-a__text">Office Printing</span></a></div>
            ...
            <div class="c-linkColumn__item"><a href="../industrial_products/" class="c-link-a"><span class="c-link-a__text">Industrial Products</span></a></div>
...
G.mfx.router_mode = "history";
        ...
        <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/technology/tech/office_printing/js/office_printing.js" defer=""></script>
