...
require_once dirname(__DIR__, 2) . '/includes/rh-contact-form.php';

$formState = ['ok' => false, 'message' => '', 'values' => []];
if (strtoupper($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    $formState = rh_contact_form_handle($_POST);
}

$rhContactMain = rh_contact_form_render($formState);
...
<title>Contact | Global | Ricoh</title>
    <meta name="Description" content="Contact Ricoh — send your inquiry using our contact form.">
<meta property="og:title" content="Contact | Global | Ricoh">
    ...
    <meta property="og:description" content="Contact Ricoh — send your inquiry using our contact form.">
...
<link rel="stylesheet" href="__RH_BASE__/assets/css/contact-form.css">
...
<a href="../contact/" class="gl-menu_link  fn-menu_main fn-current" aria-current="page"><span>Contact</span></a>
