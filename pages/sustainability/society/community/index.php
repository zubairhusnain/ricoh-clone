...
<title>Global Policy for Social Contribution Activities | Global | Ricoh</title>
...
<meta property="og:title" content="Global Policy for Social Contribution Activities | Global | Ricoh">
...
<meta property="og:url" content="__RH_BASE__/sustainability/society/community">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Global Policy for Social Contribution Activities</span>
                            </li>
                </ul>
            </div>
        </div>
    ...
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item">
          <a href="#activities" class="c-ancLink-a__link">
...
<div class="c-text-a">
  <p class="c-text-a__text">
    Our mission &amp; vision endorse the Ricoh founding principles embodied in The Spirit of Three Loves —Love your
    neighbor, Love your country, Love your work—through which we empower individuals to find fulfillment through work by
    understanding and transforming how they work, so they can unleash their potential and creativity to realize a
    sustainable future. Under this mission, we set the six materiality issues, Creativity from Work, Safe and secure
    digital society, Fair corporate activities, Inclusive workforce, Coexistence with communities, Zero-carbon society
    and circular economy.
  </p>
  <p class="c-text-a__text">
    Our social contribution activities are also aligned with our management policy and SDGs and we set Priority Areas
    based on our Materiality and global demand. Our Priority Areas are 1) Inclusion in the Workplace, 2) Community and
    Social Development, and 3) Response to Climate Crisis and Biodiversity. To maximize the effects of our contributions
    toward solving challenges, we have also set fundamental principles on social contribution. Under these principles,
    Group companies are implementing measures by leveraging the Group’s strengths, including human and other resources.
  </p>
  <a class="c-link-a icon-hidden" href="../../materiality/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt=""><span class="c-link-a__text">Materiality for the Ricoh Group</span>
  </a>
</div>

<div id="activities" class="c-h2-a">
...
<div class="c-text-a">
  <p class="c-text-a__text">
    The Ricoh Group, mindful of its responsibility as a corporate citizen, respects the cultures and customs of all
    countries and regions, joining in active partnership with like-minded people and inspiring employees to contribute
    to the development of a sustainable society and planet.
  </p>
  <p class="c-text-a__text">
    Reflecting a deep understanding of social issues in various parts of the world, our group companies carry out social
    activities focusing on several priority areas.
  </p>
</div>
...
<div class="c-table c-table--scrollX-sp">
  <table data-sp-table-width="640">
    <tbody>
      <tr>
        <th class="u-font-bold" rowspan="2">
          Philosophy
        </th>
        <th class="u-font-bold" style="background: none;">
          Ricoh Way
        </th>
      </tr>
      <tr>
        <td>
          ...
          At Ricoh, we empower individuals to find Fulfillment through Work by understanding and transforming how people
          work so we
      ...
      <tr>
        <td>
          <strong>Practical contributions to society</strong>
      ...
      <tr>
        ...
        <td>
          <ul style="list-style: none; padding-left: 0;">
            <li class="priority-list-item blue">
              <p>
                Inclusion in the Workplace
              </p>
              <div class="priority-list-item__img">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/solve-social-issues/img/sdg_icon_08_en.png" alt="image:Decent work and Economic Growth" width="63" height="63" loading="lazy">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/csr/community/img/sdg_icon_10_en.png" alt="image:Reduced Inequalities" width="63" height="63" loading="lazy">
              </div>
            </li>
            <li class="priority-list-item red">
              <p>
                Community and Social Development<br>
                <span class="u-fz-14">(Education, Healthcare and Community building)</span>
              </p>
              <div class="priority-list-item__img">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/solve-social-issues/img/sdg_icon_03_en.png" alt="image:Good Health And Well-being" width="63" height="63" loading="lazy">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/csr/community/img/sdg_icon_04_en.png" alt="image:Quality Education" width="63" height="63" loading="lazy">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/csr/community/img/sdg_icon_11_en.png" alt="image:Sustainable Cities And Communities" width="63" height="63" loading="lazy">
              </div>
            </li>
            <li class="priority-list-item green">
              <p>
                Response to Climate Crisis and Biodiversity
              </p>
              <div class="priority-list-item__img">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/solve-social-issues/img/sdg_icon_13_en.png" alt="image:Climate Action" width="63" height="63" loading="lazy">
                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/csr/community/img/sdg_icon_15_en.png" alt="image:Life On Land" width="63" height="63" loading="lazy">
              </div>
            </li>
          </ul>
          <div class="u-text-left" style="margin-top: 1em;">
            <a class="c-link-a icon-hidden" href="../will/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt=""><span class="c-link-a__text">
                The Ricoh group's Social Contribution Activities
              </span>
            </a>
          </div>
        </td>
  ...
  <p class="c-text-a__text u-fz-14">
    <sup>*</sup>Only relevant parts from Ricoh Way and Ricoh Business Conduct Guidelines are cited
  </p>
  <a href="#" class="c-link-a c-link-a--in-page icon-hidden" style="display: block;margin-left: auto;">
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">PDCA Cycle for Social Contribution Activities</h2>
    </div>
    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">
    To best solve social issues, we maximize the efficiency of each activity around the world through the PDCA cycle and
    common group indicators. By knowledge sharing and horizontal development, we strive for consistency among group
    companies.
  </p>
</div>
...
<div class="c-figure">
  <div class="c-figure__inner">
    <figure class="c-figure__item" style="max-width: 468px; width: 100%;">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/csr/community/img/policy_img05.jpg" alt="PDCA Cycle for Social Contribution Activities" style="width: 100%; height: auto;">
    </figure>
  </div>
</div>
...
<div class="c-linkTile c-linkTile--col3">
  <div class="c-linkTile__inner">
    <a href="../will/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Social Contribution Activities</span>
          </div>
        </div>
      </div>
    ...
    <a href="../sector/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Collaboration with the Social Sector</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    </a>
    <a href="../performance/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Social Contribution Achievements</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
