...
<title>Diversity, Equity, Inclusion and Work-Life Management | Global | Ricoh</title>
...
<meta property="og:title" content="Diversity, Equity, Inclusion and Work-Life Management | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/sustainability/society/diversity-equity-inclusion-worklife-management">
...
<link rel="canonical" href="../diversity-equity-inclusion-worklife-management/">
...
<li>
  <a href="../">Society</a>
                                ...
                                <li class="act">
                                    <span>Diversity, Equity, Inclusion and Work-Life Management</span>
                                </li>
                </ul>
            </div>
        </div>
...
<section class="c-section " id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Basic Policy for Diversity, Equity, Inclusion and Work-Life Management</h2>
                    </div>
...
When diverse people demonstrate their individuality and capabilities to the fullest and combine their wisdom, they can create innovation and deliver highvalue-added products and services that meet diverse customer needs.<br>
To realize this, we need to create an environment where diverse people can play active roles. Each employee needs to manage both their work and private life and work with high productivity.<br>
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Diversity, Equity, Inclusion Statement</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
<p class="c-text-a__text">
At Ricoh, we embrace and respect the collective and unique talents, experiences, and perspectives of all people. Together, we inspire remarkable innovation.<br>
Thatʼs how we live the Ricoh Way.
</p>
 </div>
                            </div>
                                    ...
                                    <div class="c-linkCard__image">
                                            <div class="c-linkCard__imageInner c-linkCard__imageInner--noRatio">
                                                <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/society/diversity-equity-inclusion-worklife-management/img/diversity_img16.jpg" alt="">
                                            </div>
                                    </div>
                            </div>
                    </div>
...
<div class="c-text-a">
<p class="c-text-a__text">
At Ricoh, we embrace and respect the collective and unique talents, experiences, and perspectives of all people.<br>
Together, we inspire remarkable innovation.<br>
Thatʼs how we live the Ricoh Way.
</p>
 </div>
    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Diversity, Equity, Inclusion as Our Management Policy</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
...
<div class="c-link-a-list">
  <div class="c-link-a-list__inner">
    <a href="../../materiality/" class="c-link-a icon-hidden">
      ...
      <span class="c-link-a__text">Seven Material Issues and SDGs</span>
    </a>
  </div>
</div>
<!-- 日本語版ここまで -->
...
<div class="c-link-a-list">
  <div class="c-link-a-list__inner">
    <a href="../vision/code_of_conduct.html/" class="c-link-a icon-hidden">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">the Ricoh Group Code of Conduct</span>
    </a>
  </div>
</div>
<!-- 日本語版ここまで -->
...
<div class="c-multiCol">
  <div class="c-linkCard c-linkCard--col2"><!-- c-linkCard--colXクラスの数値を変更することで1-5カラムまで変更することができます。 -->
    ...
    <div class="c-linkCard__item">
      <a href="../diversity-equity-inclusion-worklife-management/japan/" class="c-linkCard__link">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">Initiatives in Japan</div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/society/diversity-equity-inclusion-worklife-management/img/tmb01.jpg" alt="">
          </div>
        </div>
      </a>
    </div>
    ...
    <!-- item2 ここから -->
    <div class="c-linkCard__item">
      <a href="../diversity-equity-inclusion-worklife-management/global/" class="c-linkCard__link">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">Global Initiatives</div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/society/diversity-equity-inclusion-worklife-management/img/tmb02.jpg" alt="">
          </div>
        </div>
      </a>
    </div>
  ...
  <div class="c-linkTile__inner">
    <!-- タイトルのみの場合 ここから -->
    <a href="../labor/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../system/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Various Systems for Supporting a Healthy Work-Life Balance</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- タイトルのみの場合 ここまで -->
    <!-- タイトルのみの場合 ここから -->
    <a href="../safety/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Occupational Health and Safety</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
