    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text fs18">
    <strong>
      Stakeholder engagement is an essential part of sustainability management. We listen carefully to our customers,
      suppliers and all other stakeholders, take their feedback seriously and incorporate their input into our internal
      reform efforts.
    </strong>
  </p>
  <p class="c-text-a__text">
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Engaging stakeholders</h2>
                    </div>
                    <div class="c-text-a">
        <div class="c-multiCol">
  <div class="c-linkCard c-linkCard--col2">
    <div class="c-linkCard__item">
      <div class="c-linkCard__inner c-table">
        <table class="p-engagement-table">
          <colgroup>
            ...
            <tr>
              ...
              <td>
                <ul class="c-list-disc-a">
                  ...
                  <li class="c-list-disc-a__item c-list-disc-a__item--black">
                    Respect the cultures and customs of the countries and regions in which we operate, and contribute to
                    their development
                  </li>
                </ul>
              </td>
...
<section class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text c-text--indent">
      Our social responsibility efforts have evolved in three stages: from assessing legal, regulatory and other
      external requirements; to mission- and responsibility-driven voluntary activities that proactively meet
      expectations from society to the third stage, where we work to create shared value by solving social issues while
      concurrently accelerating our growth. To govern and monitor Group-wide activity in each of the three stages, we
      deploy our sustainability management cycle. Under this system, the Head Office collects information and feedback
      from operating organizations on the ground to identify and provide necessary support. The Head Office and
      operating units also hold periodic opinion exchanges and discussion forums to improve the quality of their
      respective sustainability activities.
    </p>
  </div>
</section>
    ...
    <table data-sp-table-width="640">
      ...
      <thead>
        <tr>
          ...
          <th>
            Reflected in business operation and products and services
          </th>
          <th>
            Major issues
          </th>
      ...
      <tbody>
        <tr>
          <th rowspan="5" class="u-align-left">
            Customers
          </th>
          <td class="u-align-left">
            Customer support including call centers and website
          </td>
          <td>
            Daily
          </td>
          <td rowspan="5" class="u-align-left">
            <ul class="c-list-disc-a">
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
                Resolving customer issues
              </li>
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
                Improving products and services based on the voice of customers through sales activities, inquiries to
                call centers, customer satisfaction survey results, etc.
              </li>
            </ul>
          </td>
          <td rowspan="5" class="u-align-left">
        ...
        <tr>
          <th class="u-align-left" rowspan="4">
            Business partners
          </th>
          <td class="u-align-left">
            ESG briefings and seminars
          </td>
          <td>
            Once or more a year
          </td>
          <td class="u-align-left" rowspan="4">
            <ul class="c-list-disc-a">
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
          ...
          <td class="u-align-left" rowspan="4">
            <ul class="c-list-disc-a">
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
                ESG-related activities throughout the supply chain
              </li>
            </ul>
          </td>
        </tr>
        ...
        <tr>
          <td class="u-align-left">
            Supporting suppliers' process improvement and decarbonization activities
          </td>
          <td>
            Regularly
          </td>
        ...
        <tr>
          <td class="u-align-left">
            Supplier and Partner Hotline (whistle-blowing system)
          </td>
          <td>
            Always
          </td>
        ...
        <tr>
          <th rowspan="6" class="u-align-left">Shareholders and investors</th>
          <td>General Shareholders' Meeting</td>
          <td>Annually</td>
          <td rowspan="6">
            <ul class="c-list-disc-a">
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
        ...
        <tr>
          <td class="u-align-left">Investors’ Meetings</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">Integrated Report, ESG Data Book, Newsletters</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">IR website</td>
          <td>As needed</td>
        </tr>
        <tr>
          <td class="u-align-left">Small meetings with investors</td>
          <td>As needed</td>
        </tr>
        <tr>
          <td class="u-align-left">Responding to assessments by ESG rating agencies</td>
          <td>As needed</td>
        </tr>
        <tr>
          <th rowspan="6" class="u-align-left">Employees</th>
          <td class="u-align-left">Video messages from CEO</td>
          <td>Monthly</td>
          <td rowspan="6" class="u-align-left">
            <ul class="c-list-disc-a">
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
                Promoting the creation of innovation by sharing the vision that the company is aiming for and creating
                an environment where diverse employees can play active roles
              </li>
            </ul>
          </td>
          <td rowspan="6" class="u-align-left">
        ...
        <tr>
          <td class="u-align-left">Dialogues with management members</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">Employee engagement survey</td>
          <td>Annually</td>
        </tr>
        <tr>
          <td class="u-align-left">1 on 1 meetings between superiors and subordinates</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">Intranet and internal newsletters</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">Whistle-blowing system</td>
          <td>Always</td>
        </tr>
        <tr>
          <th rowspan="4" class="u-align-left">Communities</th>
          <td class="u-align-left">Activities contributing to local communities</td>
          <td>Regularly</td>
          <td rowspan="4" class="u-align-left">
            <ul class="c-list-disc-a">
              <li class="c-list-disc-a__item c-list-disc-a__item--black">
        ...
        <tr>
          <td class="u-align-left">Dispatch of lecturers to seminars and educational activities</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">Activities through trade associations</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <td class="u-align-left">Information disclosure in publications and websites</td>
          <td>Regularly</td>
        </tr>
        <tr>
          <th rowspan="4" class="u-align-left">Global environment</th>
          <td class="u-align-left">Regular disclosure of environmental impact through ESG Data Book and Sustainability
            Report</td>
          <td>Annually</td>
          <td rowspan="4" class="u-align-left">
            <ul class="c-list-disc-a">
        ...
        <tr>
          <td class="u-align-left">Dialogues with NPOs/NGOs</td>
          <td>As needed</td>
        </tr>
        <tr>
          <td class="u-align-left">Volunteer activities by employees</td>
          <td>Regularly</td>
        </tr>
      </tbody>
    </table>
...
<section class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      The Ricoh Group sets a theme each year and applies it to its own sustainability management through dialogue and
  ...
  <div class="c-table">
    <table>
      <colgroup>
        ...
        <col class="c-table__col--w85p">
      </colgroup>
      <tbody><tr>
        <th rowspan="2" class="c-table__th--gray">
          FY2023
        </th>
        <td>
