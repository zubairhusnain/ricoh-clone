...
<title>Concept of sustainability | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Ricoh has delivered customer value over the years by innovating. The transformation of society is making it vital for corporate activities to address emerging social issues. Ricoh seeks to make a real difference by embracing the challenges of change遯ｶ謚較eating new value in fields where it can help resolve social issues.">
<meta property="og:title" content="Concept of sustainability | Global | Ricoh">
    ...
    <meta property="og:description" content="Ricoh has delivered customer value over the years by innovating. The transformation of society is making it vital for corporate activities to address emerging social issues. Ricoh seeks to make a real difference by embracing the challenges of change遯ｶ謚較eating new value in fields where it can help resolve social issues.">
<meta property="og:url" content="https://www.ricoh.com/sustainability/sdgs">
...
<section class="c-ancLink-a">
    <div class="c-margin-a">
      <div class="c-margin-a__inner">
        <ul class="c-ancLink-a__list">
          <li class="c-ancLink-a__item"><a href="#section01" class="c-ancLink-a__link">Basic Concept</a></li>
          <li class="c-ancLink-a__item"><a href="#section02" class="c-ancLink-a__link">Structure and Systems-ESG Committee</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Basic Concept
<br>
Driving Sustainability for our Future</h2>
                    </div>
                <div class="c-text-a" style="max-width: 1360px;">
  <p class="c-text-a__text">
    The mission and vision of the Ricoh Group are as follows: "At Ricoh, we empower individuals to find fulfillment
    through work by understanding and transforming how people work by unleashing their potential and creativity to
    realize
    a sustainable future." This mission is based on our founding principles “The Spirit of Three Loves” — Love your
    neighbor, Love your country, Love your work (, which was formulated in 1946 by our founder Kiyoshi Ichimura) . We
    are
    actively engaged in various initiatives aligned with our sustainability message, "Driving Sustainability for Our
    Future."
  </p>
  <p class="c-text-a__text">
    Building on this foundation, we express our vision for a sustainable society as the “Three Ps Balance,” where
    Prosperity
    (economy), People (society), and Planet (environment) are harmoniously balanced. With the aim of realizing a society
    that continues to develop while maintaining this balance, we became an environmental management pioneer in 1998.
    Since
    then, we have pursued both environmental conservation and profitability. Further advancing these efforts, we have
    adopted a policy of aligning ESG with business growth, integrating ESG and SDGs initiatives into our core management
    strategies and systems. Building on these efforts, we are striving to become a global ESG leader by driving
    initiatives
    across our entire value chain.
  </p>
  <p class="c-text-a__text">
    Under the Mid-Term Management Strategy ’26, we have established key goals (KGIs) to be achieved by 2030 for each of
    the
    three areas of the “Three Ps Balance.” Furthermore, in order to enhance corporate value and contribute to the Three
    Ps
    Balance, we have identified six material issues, considering social and customer expectations as well as our
    mid-term
    management strategy.
  </p>
  <!-- テキストはここを編集 -->
...
<div class="c-figure" style="margin-top: 2em;">
  <div class="c-figure__inner" style="max-width: 100%;">
    <div class="c-figure__item" style="max-width: 1000px;">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/sdgs/img/sdgs_sevenmateriality.webp" alt="SDGs and six material issues">
    </div>
  </div>
</div>
<a href="../materiality/" class="c-link-a icon-hidden" style="margin-top: 1em;">
  ...
  <span class="c-link-a__text">
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Sustainability Promotion Framework</h2>
                    </div>
                <div class="c-text-a" style="max-width: 1360px;">
  <p class="c-text-a__text">
    To ensure continuous management-level discussions on ESG issues, we have established an oversight structure through
    the
    Board of Directors and an execution framework centered on the ESG Committee as a decision-making body.
  </p>
</div>

<div class="c-text-a">
  <div class="c-h3-a" style="margin-bottom: 26px;">
...
<div class="c-figure" style="margin-top: 0;">
  <div class="c-figure__inner">
    <div class="c-figure__item">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/sdgs/img/esg_committee_en.jpg" alt="Image: ESG Committee">
    </div>
  </div>
</div>

<section class="c-text-a" style="max-width: 1360px;">
  <div class="c-h3-a">
    <h3 class="c-h3-a__text">
      &lt;Oversight structure&gt;
    </h3>
  ...
  <p class="c-text-a__text">
    The Board of Directors determines the Company’s material social issues (materiality), taking into account
    sustainability-related risks and opportunities, and approves and oversees the execution of ESG policies and business
    plans. The Board also monitors, supervises, and advises on management risks and opportunities in line with our
    oversight structure.
  </p>
</section>
<section class="c-text-a" style="max-width: 1360px;">
  ...
  <p class="c-text-a__text">
    The ESG Committee is a decision-making body chaired by the CEO and meets quarterly. From fiscal 2026, it has
    consisted of the CFO, CSO, CTO, CISO, CMO, CSRO<sup>*</sup>, CHRO, business unit presidents, and heads of
    functional
    organizations. The Chairman of the Board and full-time Audit &amp; Supervisory Board Members attend the ESG Committee as
    observers. The ESG Committee deliberates on future business risks and opportunities in sustainability, the
    identification of material social issues (materiality), the setting of ESG targets, and investments in renewable
    energy, among other matters. Important matters are determined subject to the approval of the Board of Directors
  </p>
  <p class="c-text-a__text">
    Key ESG themes, including decisions made by the ESG Committee, are incorporated into specific targets and measures
    for each functional organization and business unit, and the ESG Committee regularly reviews the progress of these
...
<!-- テキストはここを編集 -->
<div class="u-mt-16 u-pb-16 u-pt-16 u-pl-16 u-pr-16 u-bd-1s-c9">
  ...
  <ol class="u-mt-16">
    <li>Supervise and advise on ESG strategy formulation, material issues, and progress in KPIs for each business
      division throughout the entire Group
    </li>
    <li>Identify medium- to long-term ESG risks and opportunities as well as material issues faced by the entire Group
    </li>
    <li>Identify ESG issues to be submitted for discussion at the Board of Directors and report them to the Board of
      Directors
    </li>
  </ol>
</div>
...
<div class="c-table c-table--scrollX-sp">
  ...
  <table data-sp-table-width="640">
    <!-- テーブルの最小幅を入力(px単位) -->
    <caption class="u-fz-14" style="caption-side: bottom;
             text-align: left;
             margin-top: 1em;">
      <sup>*</sup> DJ BIC(Dow Jones Best-in-Class) Indices is the renamed Dow Jones Sustainability Indices (DJSI) and
      selects companies with outstanding sustainability performance based on assessments conducted by S&amp;P Global.
    </caption>
    <colgroup>
    ...
    <tbody>
        ...
        <td>
          <ul class="c-list-disc-a">
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] FY2024 ESG target performance and revenue from businesses contributing to the resolution of
              social issues
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] Disclosure on environmental risks and opportunities for FY2025
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Report] Responses to EU regulatory revisions and U.S. policies
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Report]Results of the FY2024 human rights self-assessment analysis and future actions
            </li>
          </ul>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <ul class="c-list-disc-a">
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] Issuance of the Sustainability Report
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Deliberation] Response status to DJ BIC Indices* and the future direction of ESG improvement initiatives
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Deliberation] Formulation of materiality under the Mid-Term Management Strategy ’26
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Report] ESG-related requests from overseas customers
            </li>
          </ul>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <ul class="c-list-disc-a">
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] Future direction of ESG improvement initiatives
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] Revisions to decarbonization targets and the policy for introducing renewable electricity for
              FY2025-2026
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] Materiality and ESG targets under the Mid-Term Management Strategy ’26
            </li>
        </ul></td>
      </tr>
      <tr>
        <td>Fourth<br>Meeting</td>
        <td>February</td>
        <td>
          <ul class="c-list-disc-a">
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Approval] Final proposal for materiality and ESG targets, and the setting of targets for the Three Ps
              under the Mid-Term Management Strategy ’26
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Report] Cases of customer requirements related to social issues and ESG in Europe and the United States
            </li>
            <li class="c-list-disc-a__item c-list-disc-a__item--black">
              [Report] Sustainability information disclosure for FY2026
            </li>
          </ul>
        </td>
      </tr>
