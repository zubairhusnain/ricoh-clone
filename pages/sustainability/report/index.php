...
<title>Reports on Ricoh's ESG | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Introducing reports on ESG initiatives, including ESG Databook, TCFD Report, and Circular Economy Report.">
<meta property="og:title" content="Reports on Ricoh's ESG | Global | Ricoh">
    ...
    <meta property="og:description" content="Introducing reports on ESG initiatives, including ESG Databook, TCFD Report, and Circular Economy Report.">
<meta property="og:url" content="__RH_BASE__/sustainability/report">
...
<li>
  <a href="../">Sustainability</a>
                                ...
                                <li class="act">
                                    <span>Reports on Ricoh's ESG</span>
                                </li>
                </ul>                </ul>
            </div>
        </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">The Integrated Report discloses initiatives of Ricoh Group. Environmental report and ESG databook disclose overall ESG information of Ricoh Group. Stakeholder feedback regarding various aspects of our corporate activities helps us to enhance corporate value.</p><!-- テキストはここを編集 -->
</div>      
<div class="c-multiCol">
  <div class="c-linkCard c-linkCard--col2">
    <div class="c-linkCard__item">
      <a href="../../about/integrated-report/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">Integrated Report</span>
          <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
      <div class="u-dsp-f u-mt-24" style="gap: 16px;">
        <div class="c-figure u-w-30p">
          <div class="c-figure__inner">
            <div class="c-figure__item">
              <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/report/img/top2025.jpg" alt="image:Integrated Report">            
            </div>
          </div>
        </div> 
        <div class="c-text-a">
          <p class="c-text-a__text">Overviewing the Ricoh Group’s value creation endeavors</p><!-- テキストはここを編集 -->
        </div>          
      </div>          
    </div>
    <div class="c-linkCard__item">
      <a href="sustainability/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">Sustainability Report</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
      <div class="u-dsp-f u-mt-24" style="gap: 16px;">
        <div class="c-figure u-w-100p">
          <div class="c-figure__inner">
            <div class="c-figure__item">
              <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/report/img/environmental_report_2025.jpg" alt="image:Environmental Report">            
            </div>
          </div>
        </div> 
        <ul class="c-list-disc-a">
          <li class="c-list-disc-a__item c-list-disc-a__item--black">We disclose information on our ESG strategies, as well as our initiatives and achievements in the areas of environment and human rights.</li>
          <li class="c-list-disc-a__item c-list-disc-a__item--black">Regarding climate action and biodiversity conservation, we provide disclosures in line with the TCFD and TNFD frameworks.</li>
        </ul>      
      </div> 
    </div>
    <div class="c-linkCard__item">
      <a href="databook/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">ESG DataBook</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
      <div class="u-dsp-f u-mt-24" style="gap: 16px;">
        <div class="c-figure u-w-30p">
          <div class="c-figure__inner">
            <div class="c-figure__item">
              <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/report/img/report_2.jpg" alt="image:TCFD Report">            
            </div>
          </div>
        </div> 
        <div class="c-text-a">
          <p class="c-text-a__text">Presenting key environmental, social, and governance data</p><!-- テキストはここを編集 -->
        </div>      
      </div> 
    </div>
    <div class="c-linkCard__item">
      <a href="past/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">Archive</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
      <div class="u-mt-24">
      <a href="environment/" class="c-link-a icon-hidden">
        ...
        <span class="c-link-a__text">Environmental Report （FY2024）</span>
      </a><br>
      <a href="tcfd/" class="c-link-a icon-hidden">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
        <span class="c-link-a__text">TCFD Report （FY2021-FY2023）</span>
      </a>
      <a href="ce/" class="c-link-a icon-hidden u-dsp-b">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
        <span class="c-link-a__text">Circular Report（FY2021-FY2023）</span>
      </a>
      <a href="past/" class="c-link-a icon-hidden">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
        <span class="c-link-a__text">Sustainability Report（FY1999-FY2011）</span>
      </a>
    </div>
    </div>
  </div>
