        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Third-party verification of environmental and social data</span>
                            </li>
                </ul>
            </div>
        </div>
...
<section class="c-section " id="section01">
  ...
  <p class="c-text-a__text">
    The Ricoh Group's major environmental performance data, including greenhouse gas emissions (Scope
    1, 2 and 3), major social data are subject to independent verification by SGS Japan Inc. a
    third-party audit provider, as a way of enhancing the credibility of the data and our
    compliance system. Audit results are posted on our website for easy access by our stakeholders.
  </p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Verification was conducted on information systems, methods of data collection, compilation
    and
    analysis, as well as data accuracy. </p>
  <p class="c-text-a__text">We will work continuously to enhance our data credibility through the use of third-party
    verification services and expansion of the scope of verification, thereby raising the quality
    of our environmental activities.</p>
</div>
<div class="c-text-a">
  <a hhref="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/data/pdf/report_e_2024.pdf/" target="_blank" style="display: block;">
    </a><figure class="figure"><a hhref="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/data/pdf/report_e_2024.pdf/" target="_blank" style="display: block;">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/verification/img/2024.jpg" alt="" width="595" height="841" style=" width: auto;
           height: auto;
           margin: 0 auto;">
      </a><figcaption><a hhref="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/data/pdf/report_e_2024.pdf/" target="_blank" style="display: block;">
        </a><a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/verification/pdf/ASSURANCE_REPORTSustainalility_and_Social_Data_Calculation_Report_FY24.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
          <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
          <span class="c-link-a__text">ASSURANCE REPORT/Sustainalility and Social Data Calculation
            Report (FY2024)(PDF 1410KB)</span>
          
      </a></figcaption><a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/verification/pdf/ASSURANCE_REPORTSustainalility_and_Social_Data_Calculation_Report_FY24.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
    </a></figure><a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/verification/pdf/ASSURANCE_REPORTSustainalility_and_Social_Data_Calculation_Report_FY24.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
  </a>
</div>

<aside class="c-text-a">
  <div class="c-h2-a">
  ...
  <ul style="padding-left: 0;">
    <li>
      <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/data/pdf/report_e_2023.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
        <span class="c-link-a__text">ASSURANCE STATEMENT (FY2023) (397KB)</span>
      </a>
    </li>
    <li>
      <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/data/pdf/report_e_2022.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
        <span class="c-link-a__text">ASSURANCE STATEMENT (FY2022) (192KB)</span>
      </a>
    </li>
    <li>
      <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/data/pdf/report_e_2021.pdf/" target="_blank" class="c-link-a c-link-a--pdf icon-hidden">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
        <span class="c-link-a__text">ASSURANCE STATEMENT (FY2021) (179KB)</span>
      </a>
    </li>
  </ul>
</aside>
