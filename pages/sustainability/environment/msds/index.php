...
<title>Safety Data Sheet (SDS) | Global | Ricoh</title>
...
<meta property="og:title" content="Safety Data Sheet (SDS) | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/sds">
...
That is why Ricoh would like to provide you the SDS on the web site.
Please log-in the link below.
</p></div>
  ...
  <div class="c-linkTile__inner">
    <!-- item1 start -->
    <a href="https://jp.ricoh.com/environment/msds" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
    ...
    <!-- item1 end -->
    <!-- item2 start -->
    <a href="asia-pacific/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Asia</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- item2 end -->
    <!-- item3 start -->
    <a href="china/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
    ...
    <!-- item4 start -->
    <a href="europe-middleeast-africa/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Europe</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- item5 start -->
    <a href="americas/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Americas</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    ...
    <!-- item5 end -->
    <!-- item6 start -->
    <a href="canada/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">Canada</span>
          </div>
        </div>
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
