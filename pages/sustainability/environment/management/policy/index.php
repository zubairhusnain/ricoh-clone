...
<title>Vision and Concept | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] [Ricoh Global Official Website] Introducing the philosophy that forms the basis of Ricoh Group's environmental management, including the Three Ps Balance and Comet Circle.">
<meta property="og:title" content="Vision and Concept | Global | Ricoh">
    ...
    <meta property="og:description" content="[Ricoh Global Official Website] Introducing the philosophy that forms the basis of Ricoh Group's environmental management, including the Three Ps Balance and Comet Circle.">
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/management/policy">
...
.c-text-a {
  ...
  .u-sp-fl-dire-col+.u-sp-fl-dire-col {
    @media(width > 640px) {
      margin-top: 16px;
    }
  }
  ...
  border-top: 56px solid #e94055d9;
  border-bottom: 0;
margin: 40px auto;
  }
</style>
...
<section class="c-section " id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="has-arrow-bottom">
  <div class="u-dsp-f u-sp-fl-dire-col">
    <section class="u-w-50p u-sp-w-100p" style="padding: 8px; box-sizing: border-box;">
      <h3>
        <a href="3ps/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;">
          <span class="c-button-a__text u-fl-justify-left">Three Ps Balance</span>
          <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
        </a>
      </h3>
      <div class="c-text-a">
        <p class="c-text">
          Ricoh describes its desired sustainable society through a Three Ps Balance—Prosperity (economic), People
          (society),
    ...
    <section class="u-w-50p u-sp-w-100p" style="padding: 8px; box-sizing: border-box;">
      <h3>
        <a href="comet/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;">
          <span class="c-button-a__text u-fl-justify-left">Comet Circle</span>
          <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
        </a>
      </h3>
      <div class="c-text-a">
        <p class="c-text">
          The Comet Circle—a concept for realizing a circular economy—expresses the greater picture of our environmental
          impact reduction scheme, which includes the scope of the Ricoh Group as a manufacturer and sales company. It
          also
          covers the entire lifecycle of our products as well as the upstream and downstream of our business activities.
        </p>
      </div>
    </section>
  </div>
  ...
  <div class="u-dsp-f u-sp-fl-dire-col">
    <section class="u-w-50p u-sp-w-100p" style="padding: 8px; box-sizing: border-box;">
      <h3>
        <a href="principle/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;">
          <span class="c-button-a__text u-fl-justify-left">Environmental Principles</span>
          <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
        </a>
      </h3>
      <div class="c-text-a">
        <p class="c-text">
          Ricoh established its Environmental Principles in 1992 to clearly show the basic policy and action guidelines
          that
          we should follow for environmental conservation.
        </p>
      </div>
    </section>
  </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Ricoh Group Environmental Declaration</h2>
                    </div>
                    <div class="c-text-a">
        <div class="cp-Section">
  <div class="p-policy-declaration">
    <h3 class="p-policy-declaration__title">
      Ricoh Group Environmental Declaration
    </h3>
    <div class="c-text-a">
      <p class="c-text-a__text">
        We proactively reduce environmental impact and strive to improve the Earth’s self-recovery capabilities to
        achieve a zero-carbon society and a circular economy through business.
      </p>
    </div>
  </div>
</div>
