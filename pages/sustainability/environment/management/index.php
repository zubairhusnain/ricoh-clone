...
<title>Environmental Management System | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] [Ricoh Global Official Website] Introducing our management system, guidelines, concepts, environmental goals, and the philosophy that underpin Ricoh Group's environmental management.">
<meta property="og:title" content="Environmental Management System | Global | Ricoh">
    ...
    <meta property="og:description" content="[Ricoh Global Official Website] Introducing our management system, guidelines, concepts, environmental goals, and the philosophy that underpin Ricoh Group's environmental management.">
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/management">
...
<section class="c-section " id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Achieving environmental conservation and profits simultaneously</h2>
                    </div>
                    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text">
    The Ricoh Group considers it essential to simultaneously protect the environment while generating profits. We
    accordingly practice environmental management, through which we strive to reduce our eco-footprint and improve the
    Earth’s regenerative capabilities Groupwide.
  </p>
</div>
...
<div class="c-linkCard c-linkCard--col2">
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h3>
      <a href="policy/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">Vision and Concept (Three Ps Balance, Comet Circle, and
          Environmental Principles)</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
    </h3>
    <div class="c-text-a">
      <p class="c-text">
        Introducing the Three Ps Balance of our ideal society, the Comet Circle concept for realizing a circular
        economy, and the Ricoh Group Environmental Principles, which clearly show the basic policy and action guidelines
        that the Group should follow for environmental conservation.
      </p>
    </div>
  </section>
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h3>
      <a href="target/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">Environmental Goals</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
    </h3>
    <div class="c-text-a">
      <p class="c-text">
        Ricoh has positioned “zero-carbon society and circular economy” as a material issue and has set environmental
        goals for 2030 and 2050 using a backcasting method.
      </p>
    </div>
  </section>
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h3>
      <a href="system/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">Structures and Systems</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
    </h3>
    <div class="c-text-a">
      <p class="c-text">
        We incorporate environmental risks and opportunities into the processes of each business activity and promote
        environmental management under a system of integrated decision-making for management and environment.
      </p>
    </div>
  </section>
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h3>
      <a href="iso/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">ISO14001 Certification</span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
      </a>
    </h3>
    <div class="c-text-a">
      <p class="c-text">
        Ricoh is promoting the cultivation of environmental management systems and actively acquiring ISO14001
        certifications.
      </p>
    </div>
  </section>
