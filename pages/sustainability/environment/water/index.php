...
<title>Effective Use of Water Resources | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Introducing our basic concept/policy, promotion system, initiatives, targets and performance on effective use of water resources.">
<meta property="og:title" content="Effective Use of Water Resources | Global | Ricoh">
    ...
    <meta property="og:description" content="Introducing our basic concept/policy, promotion system, initiatives, targets and performance on effective use of water resources.">
<meta property="og:url" content="__RH_BASE__/sustainability/environment/water">
...
<ul class="breadcrumb__list">
  ...
  <li class="act">
  <span>Effective Use of Water Resources</span>
  </li>
</ul>
                </ul>
            </div>
...
<div class="c-container">
        ...
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/water/img/mainvisual_2.jpg" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/water/img/mainvisual_2.jpg&quot;);"></div>
...
<section class="c-ancLink-a">
  ...
  <p class="c-text-a__text">As the world's population increases and economic development progresses, the escalation of problems related to water stress and water pollution are becoming social issues. Consequently, corporations are expected to utilize water resources effectively, reduce consumption, and prevent pollution.<br><br>
...
<div class="u-mt-16 u-pt-16 u-pb-16 u-pl-16 u-pr-16" style="border: solid 1px black;">
    <div class="c-h3-a">
        <h3 class="c-h3-a__text">Water Policy</h3>
    </div>
    <div class="c-text-a" style="max-width: 1360px; margin-top: 0px;">
        <p class="c-text-a__text">1.We will act based on the recognition that access to safe and secure water resources is the right for all people.<br>
        2.We will act by setting targets, considering the impact of our business activities on water resources as well as regional characteristics.<br>
      3.We will manage water resources in compliance with laws and regulations as well as international standards, initiatives, and public policies.<br>
4.We will contribute to solving water resource issues not only within our own company but also in society through our technological innovations.<br>
5.We will strive to improve the awareness of all employees, with each taking the initiative in communicating with stakeholders to help solve water resource issues in local communities.<br>
...
<div class="c-h3-a">
        <h3 class="c-h3-a__text">Collating data and formulating water management plans​</h3>
</div>

<div class="c-text-a">
  <p class="c-text-a__text">The Ricoh Group formulates water management plans for its approximately 300 global sites, including major production sites, based on the amounts of water used, discharged, and recycled, and manages the plans and results for each fiscal year. The Ricoh Group's environmental impact monitoring system analyzes data on water intake and wastewater discharge and utilizes this data for PDCA management.</p><!-- テキストはここを編集 -->
</div>

<div class="c-h3-a">
        <h3 class="c-h3-a__text">Water risk assessment and response to water stress regions​</h3>
</div>

<div class="c-text-a">
  <p class="c-text-a__text">We utilize the "Aqueduct Water Risk Atlas" from the World Resources Institute (WRI) to assess water stress and water scarcity risks at our production sites and conduct water risk assessments. Among the indicators set in "Aqueduct Water Risk Atlas 4.0," business sites categorized as "high" or above in "Baseline Water Stress" or "Baseline water depletion" are identified as "water stress areas." As a result of the evaluation, it has been confirmed that the withdrawal rate from water stress areas accounts for less than 10% of Ricoh Group's total water intake, and sites located in water stress areas comprise less than 10% of all Ricoh Group business sites. The water stress areas in which we operate include seven locations: China, Thailand, Indonesia, the US and France with a total water intake of 274,586㎥ for fiscal year 2024. As part of measures in water stress areas, we actively engage in dialogue with stakeholders such as local administrations and communities. For example, we set voluntary targets significantly below the water intake restriction limits imposed by authorities and have achieved initiatives towards meeting these targets.</p><!-- テキストはここを編集 -->
</div>
                            </div>
                                            </div>
                </div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout2">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
	<p class="c-text-a__text">The Ricoh Group prioritizes the conservation of local environments and strives to maximize the effective utilization of water. To achieve this, the group establishes overall targets and evaluates water usage, identifying opportunities for improving water efficiency and actively engaging in related initiatives. In areas where water withdrawal requirements are set by the local government and water stress is a serious concern, we set targets based on indicators to ensure that we comply with government requirements and use water efficiently according to the characteristics of our business. To comply with regulations and solve local water issues, we are working to establish voluntary standards that are stricter than government regulations.</p><!-- テキストはここを編集 -->
</div>

<div class="c-h3-a">
        <h3 class="c-h3-a__text">Water withdrawal in business activities​</h3>
</div>

<div class="c-text-a">
	<p class="c-text-a__text">Target: Reduce the volume of water withdrawal below that of the previous year*<br>
*Target for FY 2024: ＜3,451(1,000㎥) / Target for FY 2025: ＜3,273(1,000㎥)<br>
Scope of data collection: Ricoh Company, Ltd. (production/non-production sites), Ricoh group sites inside and outside Japan</p><!-- テキストはここを編集 -->
</div>

<div class="c-figure">
	<div class="c-figure__inner" style="margin: 0px;">
	  <div class="c-figure__item">
		<img width="100%" src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/water/img/water_data_img_en.webp" alt="Image: Water-related data" class="u-w-50p">    
	  </div>
	</div>
  </div>
...
<div class="c-table c-table--scrollX-sp"><!-- ここに.c-table--scrollX-spクラスを追加 -->
                  ...
                  <th class="al_c">FY2024</th>
					  ...
					  <tr>
                  <td class="al_l">Water withdrawal （1,000㎥）</td>
                  <td class="al_r">3,473</td>
                  <td class="al_r">3,499</td>
                  <td class="al_r">3,451</td>
                  <td class="al_r">3,273</td>
                  </tr>
					  <tr>
                  <td class="al_l">Water discharge  （1,000㎥）</td>
                  <td class="al_r">2,646</td>
                  <td class="al_r">2,820</td>
                  <td class="al_r">2,491</td>
                  <td class="al_r">2,410</td>
                  </tr>
            <tr>
                  <td class="al_l">Water consumption （1,000㎥）</td>
                  <td class="al_r">828</td>
                  <td class="al_r">679</td>
                  <td class="al_r">960</td>
                  <td class="al_r">863</td>
                  </tr>
            <tr>
                  <td class="al_l">Reused / recycled volume</td>
                  <td class="al_r">231</td>
                  <td class="al_r">250</td>
                  <td class="al_r">252</td>
                  <td class="al_r">206</td>
                  </tr>
            <tr>
                  <td class="al_l">Reused / recycled rate (%)</td>
                  <td class="al_r">6</td>
                  <td class="al_r">7</td>
                  <td class="al_r">7</td>
                  <td class="al_r">6</td>
        ...
        <p>*Due to changes in organizational structure, the scope of disclosure has been revised and related figures have been recalculated.</p>
			  </div>


<div class="c-text-a">
	<p class="c-text-a__text">At one of our sites in a water stress area, Shanghai Ricoh Digital Equipment Co., Ltd., in consultation with local authorities, has set water conservation goals and is actively working towards them.</p><!-- テキストはここを編集 -->
</div>

<div class="c-text-a">
	<p class="c-text-a__text">FY 2024 Target: 49.7(1,000㎥)<br>
FY 2024 Actual: 37.7 (1,000㎥)
</p><!-- テキストはここを編集 -->
</div>

<div class="c-text-a">
	<p class="c-text-a__text">In fiscal 2024, there were no violations or fines/penalties related to environmental regulations, including wastewater regulations for Ricoh Group.</p><!-- テキストはここを編集 -->
</div>
<a href="../management/system/" class="c-link-a icon-hidden">
	...
	<span class="c-link-a__text">Penalties and fines concerning the environment (including wastewater) for the Ricoh Group</span>
</a>

<div class="c-text-a">
	<p class="c-text-a__text">For more information related water resources, please see below ESG data</p><!-- テキストはここを編集 -->
</div>
<a href="../../data/" class="c-link-a icon-hidden">
  ...
  <div class="" style="padding: 8px;">
    <a href="initiative/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="max-width: unset;">
      <span class="c-button-a__text u-fl-justify-left">Initiatives for Effective Use of Water Resources
</span>
    ...
    <div style="padding: 8px;">
      <div class="c-text-a">
        <p class="c-text-a__text">The Ricoh Group has set a goal to reduce water intake and is undertaking the following activities.</p><!-- テキストはここを編集 -->
      </div>      
      <ul class="c-list-disc-a u-pl-24">
        <li class="c-list-disc-a__item c-list-disc-a__item--black">Use of gray water in collaboration with local companies</li>
        <li class="c-list-disc-a__item c-list-disc-a__item--black">Promoting recycling of water by using rainwater</li>
        <li class="c-list-disc-a__item c-list-disc-a__item--black">Closed system for surface treatment washing water</li>
        <li class="c-list-disc-a__item c-list-disc-a__item--black">Supplier engagement</li>
      </ul>
    </div>
</div>
                            </div>
