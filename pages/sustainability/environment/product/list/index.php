...
<title>List of Environmental Label Qualified Products | Global | Ricoh</title>
<meta property="og:title" content="List of Environmental Label Qualified Products | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/product/list">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>List of Environmental Label Qualified Products</span>
                            </li>
                </ul>
            </div>
        </div>
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Introducing our products with environmental labels</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/product/list/pdf/Environmental_Label_Qualified_Products.xlsx/" class="c-link-a c-link-a--download icon-hidden">
      ...
      <span class="c-link-a__text">Environmental Label Qualified Products（Excel: 36㎅）</span>
    </a>
  </div>
</div>

<ul class="c-list-disc-a u-mt-16">
  <li class="c-list-disc-a__item c-list-disc-a__item--black">Multifunction Printers</li>
  <li class="c-list-disc-a__item c-list-disc-a__item--black">Printers</li>
  <li class="c-list-disc-a__item c-list-disc-a__item--black">Digital Duplicators</li>
  <li class="c-list-disc-a__item c-list-disc-a__item--black">Commercial &amp; Industrial Printing : Wide format printers</li>
  <li class="c-list-disc-a__item c-list-disc-a__item--black">Commercial &amp; Industrial Printing : Cutsheet Printers</li>
</ul>

<div class="c-linkTile c-linkTile--col2">
  <div class="c-linkTile__inner">

    <a href="https://www.energystar.gov/" class="c-linkTile__item icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">ENERGY STAR</span>
          </div>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/product/list/img/energystar_logo.webp" alt="">
      </div>
    ...
    <a href="https://www.blauer-engel.de/en" class="c-linkTile__item icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">BLUE ANGEL</span>
          </div>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/product/list/img/label_BlueAngel.webp" alt="">
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    </a>

    <a href="https://epeat.net/" class="c-linkTile__item icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">EPEAT</span>
          </div>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/product/list/img/EPEAT.webp" alt="">
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    </a>

    <a href="https://ecoleaf-label.jp/en/" class="c-linkTile__item icon-hidden">
      <div class="c-linkTile__content">
        <div class="c-linkTile__heading">
          <div class="c-text-a c-text-a--thin">
            <span class="c-text-a__text u-font-bold">EcoLeaf</span>
          </div>
        </div>
      </div>
      <div class="c-linkTile__image">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/sustainability/environment/product/list/img/Ecoleaf.webp" alt="">
      </div>
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
    </a>
