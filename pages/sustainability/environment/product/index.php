...
<title>Environmental Information of Our Products | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] [Ricoh Global Official Website] Introducing environmental information about Ricoh's products, such as environmental labels and recycling programs.">
<meta property="og:title" content="Environmental Information of Our Products | Global | Ricoh">
    ...
    <meta property="og:description" content="[Ricoh Global Official Website] Introducing environmental information about Ricoh's products, such as environmental labels and recycling programs.">
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/product">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Environmental Information of Our Products</span>
                            </li>
                </ul>
            </div>
        </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-text-a">
        <div class="c-text-a">
<p class="c-text-a__text">Ricoh is working to design and develop environmentally friendly products and is actively working to acquire environmental labels. In addition, to reduce the environmental impact of our entire supply chain, we work to enhance environmental protection efforts in cooperation with suppliers.</p>
 </div>

<div class="c-linkCard c-linkCard--col2">
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="rspp/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
    ...
    <div class="c-text-a">
      <p class="c-text">
        Ricoh assesses its products and services based on its own indicators, and certifies products and services that
        contribute to solving social issues as "Sustainable Products," and particularly superior products as
  ...
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="label/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
  ...
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="list/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
  ...
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="cfp/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
    ...
    <div class="c-text-a">
      <p class="c-text">
        Carbon Footprint of Products (CFP) is a measure to quantify the environmental impact of products and services by
        calculating greenhouse gas (GHG) emissions throughout their life cycle.
      </p>
    </div>
  </section>
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="../msds/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
    ...
    <div class="c-text-a">
      <p class="c-text">
        To ensure that our customers correctly understand properties of chemical substances and handle them safely, we
        disclose Safety Data Sheets that describe properties of chemical substances and emergency measures in case of
        accidents.
      </p>
    </div>
  </section>
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="recycle/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
    ...
    <div class="c-text-a">
      <p class="c-text">
        To realize a circular economy, Ricoh promotes resource conservation by collecting and recycling products and
        effective use of resources. View our reuse and recycling program.
      </p>
    </div>
  </section>
  <section class="c-linkCard__item" style="padding: 8px; box-sizing: border-box;">
    <h2>
      <a href="green/" class="c-button-a c-button-a--red c-button-a--arrow c-button-a--iconWhite icon-hidden c-button-a--wide u-w-100p u-dsp-f u-fl-align-center" style="justify-content: center; max-width: initial;min-height: 112px;">
        <span class="c-button-a__text u-fl-justify-left">
          Green Procurement
        </span>
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt="">
    ...
    <div class="c-text-a">
      <p class="c-text">
        Download "Ricoh Group's Green Procurement Standards", "Ricoh Group's Guideline for Chemical Substances
        Management System", and "Non-Use Declaration of Banned Substances in Ricoh's Products".
      </p>
    </div>
  </section>
</div>
