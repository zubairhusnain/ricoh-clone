...
<link rel="stylesheet" type="text/css" media="all" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/css/template-global-addition2024.css">
    ...
    <meta charset="utf-8">
    <title>Reuse and Recycling Program | Global | Ricoh</title>
...
<script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/ScAssets/System/Lib/jquery.tile.js"></script>
    <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/ScAssets/System/Lib/jquery.responsiveTabs.js"></script><script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/ScAssets/System/Lib/fancybox-v1.4.3/JS/jquery.fancybox-1.3.4.js"></script>
...
<link rel="stylesheet" type="text/css" media="all" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/css/style.css">    <script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v1/js/import2021.js"></script></head>
<body style="">
<div id="wrapper">
        <!-- START HEADER AREA -->
...
<li>
    <a href="../../">Environment</a>
                            ...
                            <li class="act"><span>Reuse and Recycling Program</span></li>
                </ul>
...
<!-- START Parts H1Title -->
    <div class="cp-Heading1 cnt_max">
            <h1>Reuse and Recycling Program</h1>
    </div>
<!-- END Parts H1Title -->
...
<!-- ここから本ページ独自の本文ソース --><div id="Main">
        ...
        <div class="sct_bg01 pt0">
          <div class="cnt_max">
            ...
            <div class="clm1 clm2 rsp_break_clm1">
              <div class="clm">
              	<p class="fs18"><strong>Regional programs</strong></p>
              	<ul class="nml mt8">
              		<li>Americas</li>
        ...
        <div class="sct_bg01 pt0">
          <div class="cnt_max">
            <div class="clm1">
              <div class="clm">
                <h2 class="hd02 mb16"><span class="bd_2sl">Global network for our reuse and recycling activities</span></h2>
              </div>
              <!--/clm1-->
            </div>
            <div class="clm1">
              <div class="clm">
              	<p>We deploy takeback programs, reuse, and recycling efforts through our own facilities in Europe, Japan, Americas, Asia, and China business regions. Each Group company maintains standards for selecting trustworthy industrial waste contractors. These standards include such internationally recognized endorsements as ISO 14001, ISO 9001, R2, and eStewards.</p>
              </div>
            <!--/clm1-->
            </div>
            <div class="clm1">
              <div class="clm">
              	<p><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/recycle/img/05_img_map.gif" width="100%" alt="Image: Global Network for our reuse and recycling activities"></p>
              </div>
            <!--/clm1-->
            </div>
            <!--/cnt_max-->
         ...
         <div class="sct_bg01 pt0">
          <div class="cnt_max">
            <div class="clm1">
              <div class="clm">
              	<p class="mb8">For more our reuse and recycling activities, please see the following page.</p>
              	<a href="../../circular_economy/initiative_recycle/" class="ico_nml right">Initiatives for our own used resources</a>
              </div>
              <!--/clm1-->
            </div>
            <div class="clm1">
              <div class="clm">
                <p class="page_top smoothScroll"><a href="#">Page Top</a></p>
              </div>
              <!--/clm1-->
            </div>
            <!--/cnt_max-->
