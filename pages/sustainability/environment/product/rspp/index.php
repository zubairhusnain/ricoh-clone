...
<title>Ricoh Sustainable Products Program (RSPP)  | Global | Ricoh</title>
...
<meta property="og:title" content="Ricoh Sustainable Products Program (RSPP)  | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/product/rspp">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                            ...
                            <li class="act">
                                <span>Ricoh Sustainable Products Program (RSPP) </span>
                            </li>
                </ul>
            </div>
        </div>
...
<section class="c-section " id="section01">
  ...
  <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/rspp/img/main.jpg" width="1360" height="347" alt="Ricoh Sustainable Products Program (RSPP)">
</figure>
<div class="c-h2-a">
  <h2 class="c-h2-a__text">
    “Realize Sustainable Products/Services design which resolved Ricoh Group materiality for Driving Sustainability”
  </h2>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">
    Ricoh Group has established seven material issues which it needs to focus on through business, based on the
    Sustainable Development Goals that were agreed by the international community, and aims to create new markets and
    value propositions by looking broadly at social issues, and taking on the challenge to resolve them while
    simultaneously achieving social development and Ricoh's own business growth.<br>
    <a class="c-link-a icon-hidden" href="../../../materiality/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt=""><span class="c-link-a__text">More information for Ricoh Group materiality is here.</span>
    </a>
  </p>
</div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">Ricoh Group's seven materialities and RSPP</h2>
    </div>
    <div class="c-text-a">
        <figure class="c-figure c-figure--rspp">
  <img alt="Image：RICOH Sustainable Products Program" src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/rspp/img/img_prosperity.jpg">
</figure>
<div class="c-text-a">
  <p class="c-text-a__text">
    Ricoh Sustainable Products Program (RSPP) aims to deliver Sustainable Products/Services which resolved these
    material issues and driving Sustainable society for the customers.
  </p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">
    In RSPP, we assess Ricoh Group products/services by the in-house original standard and self-certificate. based on
    the
    assessment results. products/services contribute to resolve material issues are certified as “Sustainable Products”
    and
    those products judged particularly excellent are certified as “Sustainable Products-Premium”.
  </p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">
    Ricoh Group will effectively utilize this program to steer manufacturing such that all products can meet the
    criteria for “Sustainable Products”, thus more effectively contributing to enhancing the sustainability of our
  </p>
  <p class="c-text-a__text">
    Our “Mission Statement” in The RICOH Way is “At the Ricoh Group, we are committed to providing excellence to improve
    the quality of living and to drive sustainability”, which is our essential guide to each daily activity and
    management decision. To achieve this “Mission Statement”, we assess products and services by our own strict
    criteria, and certify sustainability performance and feature by ourselves in “Ricoh Sustainable Products Program”.
  </p>
</div>
<figure class="c-figure c-figure--products">
  <img alt="Image：Concept of Sustainable Products" src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/rspp/img/img_rspp01.jpg">
</figure>

<div class="c-h3-a">
  <h3 class="c-h3-a__text">
    Ratios of the products complying with the RSPP rank
  </h3>
</div>
...
<div class="c-table c-table--scrollX-sp">
  <table data-sp-table-width="640">
    <caption>
      <sup>*</sup>Ratios of the products complying with the RSPP rank（%）
    </caption>
    <thead>
      <tr>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">RSPP: Product assessment criteria</h2>
    </div>
    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">
    In “Ricoh Sustainable Products Program”, individual products and services are assessed based on criteria at the five
    assessment axis, namely, (1) Energy Efficiency, (2) Resource Efficiency, (3) Pollution Prevention, (4) Comfort, and
    (5)
    Usability. Shown below is the overview of each assessment axis and the conditions for multifunction printer rank
    certification:
  </p>
</div>
...
<div class="c-table c-table--scrollX-sp">
  <table data-sp-table-width="640">
    <caption>
      <sup>*</sup>Typical electricity consumption measured by the methods specified by the ENERGY STAR® Program
      requirements.
    </caption>
    <colgroup>
    ...
    <tbody>
      <tr>
        ...
        <td>
          Evaluates the energy efficiency of a product, including the TEC
          value<sup>*</sup>and the energy consumption in sleep mode for imaging equipment. Numerical value calculated
          using the measurement method of the international ENERGY STAR program.
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
          Evaluates the volume of resources that are used in the manufacturing of a product and how packaging is
          reduced, including the weight of the mainframe and the use of recycled materials.
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
          Evaluates how the use of chemical substances that have an environmental impact are taken into consideration in
          product design, in accordance with the European RoHS Directive (Directive on the Restriction of the use of
          certain Hazardous Substances in electrical and electronic equipment) etc.
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
          Evaluates whether the impact of a product on its surroundings varies from continued use e.g. noise and
          emissions (dust,
          TVOC, UFP etc.).
        </td>
      </tr>
      <tr>
        <th>
          Usability (Eco function)
        </th>
        <td>
          Assess whether a product possesses a function to reduce its environmental impact and specific accessibility
          features, and whether environmentally-friendly settings such as sleep mode can be easily accessed etc.
        </td>
      </tr>
    </tbody>
  </table>
...
<div class="c-h3-a">
  <h3 class="c-h3-a__text">
    Product rank certification conditions
  </h3>
</div>
  ...
  <table data-sp-table-width="640">
    ...
    <tbody>
      <tr>
        ...
        <td>
          Rank to be given to products which can comply with government / green public procurement standard / main
          environmental
          label etc. in order to resolve Ricoh Group materiality.
        </td>
      </tr>
      <tr>
        <th>
        ...
        <td>
          Rank to be given to Products that have excellent performance (industry's 'Top' or 'First' feature(s) etc.) in
          one of the criteria at least, and satisfy the Sustainable Products requirement as well.
        </td>
      </tr>
    </tbody>
  </table>
