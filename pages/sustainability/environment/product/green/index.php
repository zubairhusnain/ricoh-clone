...
<title>Green Procurement | Global | Ricoh</title>
...
<meta property="og:title" content="Green Procurement | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/sustainability/environment/product/green">
        ...
        <div class="breadcrumb__container">
            <div class="breadcrumb__inner">
                <ul class="breadcrumb__list">
                                    ...
                                    <li>
                                        <a href="../">Environmental Information of Our Products</a>
                                    </li>
                            <li class="act">
  ...
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item">
          <a href="#section01" class="c-ancLink-a__link">Green procurement standards</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section02" class="c-ancLink-a__link">CMS guidelines</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section03" class="c-ancLink-a__link">Non-use declaration</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">Green procurement standards</h2>
    </div>
    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">
    These standards for the procurement of materials and parts used in products. The materials and parts to be delivered
    to Ricoh Group companies should be procured in compliance with these standards.
    <br>（Revised in February 2026）
  </p>
</div>

<div class="c-h3-a">
  <h3 class="c-h3-a__title">
    English
  </h3>
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/green/pdf/RicohGroupsGreenProcurementStandards.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">Ricoh Group's Green Procurement Standards
          -Ver.15-[2026.02](25P
          889KB)</span>
      </a>
    </p>
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/green/pdf/EnvironmentallySensitiveChemicalSubstances.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">Environmentally Sensitive Chemical Substances -Ver.19-
          [2026.02](45P 1.00MB)</span>
      </a>
    </p>
  </div>
</div>
...
<div class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/green/pdf/RicohGroupsGreenProcurementStandards_ch.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">Ricoh Group's Green Procurement Standards (CH Version)
          -Ver.15-[2026.02](20P 1.23MB)</span>
      </a>
    </p>
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/product/green/pdf/EnvironmentallySensitiveChemicalSubstances_ch.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">Environmentally Sensitive Chemical Substances (CH Version)
          -Ver.19-[2026.02](37P 1.11MB)</span>
      </a>
    </p>
  </div>
</div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">Chemical substance management system (CMS) guidelines</h2>
    </div>
    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">
    These guidelines help our suppliers establish the chemical substance management system (CMS).
    <br>(Revised in April 2024)
  </p>
</div>
...
<div class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/guideline/pdf/cms_en.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">Chemical Substance Management System (CMS) Guidelines
          -Edition-8.0- [2024.04](37P 904KB)</span>
      </a>
    </p>
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/guideline/pdf/cms_check_e_ver6.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">(Annex)CMS Self-check Report/ CMS Audit Checklist
          -Edition6.0-
          [2010.04](7P 309KB)</span>
      </a>
    </p>
  </div>
</div>
...
<div class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/guideline/pdf/cms_cn.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">Chemical Substance Management System (CMS) Guidelines
          -Edition-8.0- [2024.04](37P 980KB)</span>
      </a>
    </p>
    <p class="c-text-a__text">
      <a class="c-link-a icon-hidden" target="_blank" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/environment/guideline/pdf/cms_check_c_ver6.pdf/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download"><span class="c-link-a__text">(Annex)CMS Self-check Report/ CMS Audit Checklist
          -Edition6.0- [2010.04](7P 362KB)</span>
      </a>
    </p>
  </div>
</div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">Non-use declaration of banned substances in Ricoh’s products</h2>
    </div>
    <div class="c-text-a">
        <div class="c-text-a">
  <p class="c-text-a__text">
    We request our suppliers to declare that their products and parts contain no banned substances.
    <br>[Note] The password to open the file is included in the email of "Request for submitting a declaration" sent to
    each
    supplier.
  </p>
</div>
...
<div class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/guideline/pdf/Non_use_declaration_ENG.doc/" class="c-link-a c-link-a--download icon-hidden">
        ...
        <span class="c-link-a__text">Non-use declaration of substances which inclusion in Ricoh Products is prohibited
          [Jan. 2021]</span>
      </a>
    </p>
  </div>
...
<div class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a class="c-link-a c-link-a--download icon-hidden" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/sustainability/environment/guideline/pdf/Non_use_declaration_CHI.doc/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/download-primary-color.svg" alt="Download"><span class="c-link-a__text">设备产品所含禁止物质 不使用宣言 [Jan. 2021]</span>
      </a>
    </p>
  </div>
</div>
...
<div class="c-h3-a">
  ...
  <div class="c-text-a">
    <p class="c-text-a__text">
      <a class="c-link-a c-link-a--download icon-hidden" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/jp_ricoh/environment/guideline/pdf/Non_use_declaration_JPN.doc/"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/download-primary-color.svg" alt="Download"><span class="c-link-a__text">機器製品含有禁止物質 不使用宣言書 ［2021.01］</span>
      </a>
    </p>
  </div>
</div>
