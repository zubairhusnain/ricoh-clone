...
<title>Support &amp; Downloads | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Ricoh's support and download information about products and services. Ricoh is one of the leading providers of office equipment, such as MFPs, Printers, Fascimiles, and related supplies and services.">
<meta property="og:title" content="Support &amp; Downloads | Global | Ricoh">
    ...
    <meta property="og:description" content="Ricoh's support and download information about products and services. Ricoh is one of the leading providers of office equipment, such as MFPs, Printers, Fascimiles, and related supplies and services.">
<meta property="og:url" content="https://www.ricoh.com/support">
...
<script src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/support/js/script.js"></script>
<link rel="stylesheet" type="text/css" media="all" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/support/css/select_country.css">
...
<li>
<a href="" class="{CD078A07-1565-4DCA-8688-B247492DCA7B} gl-menu_link  fn-menu_main fn-current" aria-current="page"><span>Support &amp; Downloads</span></a>
</li><li>
...
<div class="c-container">
        ...
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/support/img/img_mv.webp" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/support/img/img_mv.webp&quot;);"></div>
...
<section class="c-section c-section--blue" id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
    ...
    <div class="c-linkCard__item">
        <a href="intelligent-support/" class="c-linkCard__link">
            <div class="c-linkCard__text">
                <div class="c-h4-a">
                    <div class="c-h4-a__text c-linkCard__hoverRed">RICOH Intelligent Support</div>
                </div>
                <div class="c-h4-a">
                    <div class="c-h4-a__text c-linkCard__hoverRed">Maximize your uptime with easy and fast support</div>
                </div>
            </div>
            <div class="c-linkCard__image">
                <div class="c-linkCard__imageInner">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/support/img/img_related_links01.webp" alt="">
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Information</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
    ...
    <div class="c-linkTile__inner">
        <a href="../products/security/vulnerabilities/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
            <div class="c-linkTile__content">
                <div class="c-linkTile__heading u-mb-0">
                    <div class="c-text-a c-text-a--thin">
                        <span class="c-text-a__text u-font-bold">Vulnerability information for products and
                            services</span>
                    </div>
                </div>
        ...
        <a href="information/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
            <div class="c-linkTile__content">
                <div class="c-linkTile__heading u-mb-0">
                    <div class="c-text-a c-text-a--thin">
                        <span class="c-text-a__text u-font-bold">Handling of Information Assets Stored on RICOH Products At Machine End of Life</span>
                    </div>
                </div>
        ...
        <a href="end-of-support-notification/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
            <div class="c-linkTile__content">
                <div class="c-linkTile__heading u-mb-0">
                    <div class="c-text-a c-text-a--thin">
                        <span class="c-text-a__text u-font-bold">End of support of Microsoft OS equipped on Ricoh products and services</span>
                    </div>
                </div>
        ...
        <a href="information/caution/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
            <div class="c-linkTile__content">
                <div class="c-linkTile__heading u-mb-0">
                    <div class="c-text-a c-text-a--thin">
                        <span class="c-text-a__text u-font-bold">Caution for Counterfeit Products</span>
                    </div>
                </div>
        ...
        <a href="information_20230327/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
            <div class="c-linkTile__content">
                <div class="c-linkTile__heading u-mb-0">
                    <div class="c-text-a c-text-a--thin">
                        <span class="c-text-a__text u-font-bold">Notification of Partial Corrections of information on bundled CD-ROM of MFP</span>
                    </div>
                </div>
        ...
        <a href="end-of-support-for-software-products-that-require-java-module/" class="c-linkTile__item c-linkTile__item--noImage icon-hidden">
            <div class="c-linkTile__content">
                <div class="c-linkTile__heading u-mb-0">
                    <div class="c-text-a c-text-a--thin">
                        <span class="c-text-a__text u-font-bold">End of support for software products that require Java module</span>
                    </div>
                </div>
