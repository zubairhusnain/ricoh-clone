...
<style>
.c-link-a #ot-sdk-btn.ot-sdk-show-settings{
color: #cf142b;
...
width: fit-content;
-moz-transition:text-decoration-color 0.25s ease-out;
-o-transition:text-decoration-color 0.25s ease-out;
-webkit-transition:text-decoration-color 0.25s ease-out;
transition:text-decoration-color 0.25s ease-out;
text-underline-offset: 0.3rem;
}
.c-link-a #ot-sdk-btn.ot-sdk-show-settings:hover{
color: #cf142b;
background-color:#fff;
  ...
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item">
          <a href="#section01" class="c-ancLink-a__link">1. What are Cookies?</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section02" class="c-ancLink-a__link">2. How do we use Cookies?</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section03" class="c-ancLink-a__link">3. What types of Cookies do we use?</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section04" class="c-ancLink-a__link">4. Adjusting Cookie Settings and Deleting Cookies</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section05" class="c-ancLink-a__link">5. About this Cookie Policy</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-h3-a">
  <h2 class="c-h3-a__text">1. What are Cookies?</h2>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">This website use Cookies to improve our service and provide you with a better service.</p>
  <p class="c-text-a__text">Cookies are used to store information about the websites you have visited in your device (computer, tablet or smartphone).</p>
  <p class="c-text-a__text">The information that is stored may include your IP address, device used, click history, etc. (such as the web pages you visited). Information that can identify an individual, such as the customer's name, address, telephone number or email address, will not be obtained.</p>
</div>            </div>
        </div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-h3-a">
  <h2 class="c-h3-a__text">2. How do we use Cookies?</h2>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">We use Cookies for the following purposes.</p>
</div>
<ul class="c-list-disc-a">
  <li class="c-list-disc-a__item c-list-disc-a__item--black">To help improve the operation, structure, and contents of this website</li>
  <li class="c-list-disc-a__item c-list-disc-a__item--black">To provide and optimize our services</li>
  <li class="c-list-disc-a__item c-list-disc-a__item--black">For marketing activities (including personalized advertisements)</li>
</ul>            </div>
        </div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-h3-a">
  <h2 class="c-h3-a__text">3. What types of Cookies do we use?</h2>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Below is a list of the types of Cookies we use.</p>
</div>
...
<div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="" class="c-link-a c-link-a--blank">
      <span class="c-link-a__text">Cookie Settings</span>
    </a>
  </div>
</div>
-->
...
<div class="c-h4-a">
  <h3 class="c-h4-a__text">(1) Strictly Necessary Cookies</h3>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">These cookies are necessary for the website to function and cannot be switched off in our systems. They are usually only set in response to actions made by you which amount to a request for services, such as setting your privacy preferences, logging in or filling in forms. You can set your browser to block or alert you about these cookies, but some parts of our website will not then work. These cookies do not store any personally identifiable information.</p>
  <p class="c-text-a__text">If this information processed in relation to Strictly Necessary Cookies falls under personal data, the legal basis of that processing is the legitimate interest to actuate this website.</p>
</div>
<div class="c-h4-a">
  <h3 class="c-h4-a__text">(2) Performance Cookies</h3>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site. They help us to know which pages are the most and least popular and see how visitors move around the site. All information these cookies collect is aggregated and therefore anonymous. If you do not allow these cookies we will not know when you have visited our website, and will not be able to monitor its performance. 
If this information processed in relation to Performance Cookies falls under personal data, the legal basis of that processing is your consent.</p>
</div>
<div class="c-h4-a">
  <h3 class="c-h4-a__text">(3) Functional Cookies</h3>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">These cookies enable the website to provide enhanced functionality and personalization. They may be set by us or by third party providers whose services we have added to our pages. If you do not allow these cookies, then some or all of these services may not function properly.</p>
  <p class="c-text-a__text">If this information processed in relation to Functional Cookies falls under personal data, the legal basis of that processing is your consent.</p>
</div>
<div class="c-h4-a">
  <h3 class="c-h4-a__text">(4) Targeting Cookies</h3>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">These cookies may be set through our site by our advertising partners. They may be used by those companies to build a profile of your interests and show you relevant adverts on other sites. They do not store directly personal information, but are based on uniquely identifying your browser and internet device. If you do not allow these cookies, you will experience less targeted advertising.</p>
  <p class="c-text-a__text">If this information processed in relation to Functional Cookies falls under personal data, the legal basis of that processing is your consent.</p>
</div>
<div class="c-h4-a">
  <h3 class="c-h4-a__text">(5) Social Media Cookies</h3>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">These cookies are set by a range of social media services that we have added to the site to enable you to share our content with your friends and networks. They are capable of tracking your browser across other sites and building up a profile of your interests. This may impact the content and messages you see on other websites you visit. If you do not allow these cookies you may not be able to use or see these sharing tools.</p>
  <p class="c-text-a__text">If this information processed in relation to Functional Cookies falls under personal data, the legal basis of that processing is your consent.</p>
</div>            </div>
        </div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-h3-a">
  <h2 class="c-h3-a__text">4. Adjusting Cookie Settings and Deleting Cookies</h2>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">You can change your cookie preferences or withdraw your consent at any time from here. Please keep it in your mind that if you do this some functions of our website may not be available or not function properly.</p>
</div>            </div>
        </div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-h3-a">
  <h2 class="c-h3-a__text">5. About this Cookie Policy</h2>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">We update our cookie policy as necessary, such as when there has been any change to the list of Cookies used. We will notify you that in accordance with applicable laws.</p>
</div>            </div>
        </div>
    </div>
      ...
      <div class="c-margin-b__inner">
        <div class="c-linkTile c-linkTile--col3">
          <div class="c-linkTile__inner">
            <a href="../privacy-policy/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
            ...
            <a href="" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
              <div class="c-linkTile__content">
                <div class="c-linkTile__heading">
                  <div class="c-text-a c-text-a--thin">
            ...
            <a href="../group-privacy-policies/" class="c-linkTile__item c-linkTile__item--titleOnly icon-hidden">
              <div class="c-linkTile__content">
                <div class="c-linkTile__heading">
                  <div class="c-text-a c-text-a--thin">
      ...
      <div class="gl-footer-area-02_wrap">
        ...
        <div class="gl-footer-utility">
          <ul class="gl-footer-utility_inner">
            ...
            <li class="gl-footer-utility_item"><a href="../" class="gl-footer-utility_link">Privacy policy</a></li>
