...
<title>Organization | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Organization">
<meta property="og:title" content="Organization | Global | Ricoh">
...
<meta property="og:url" content="https://www.ricoh.com/about/organization">
...
<link rel="stylesheet" href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/about/organization/css/style5.css">
  ...
  <li class="c-globalNav__item" data-drawer-button="02">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="02" id="globalNavDrawerControlsId-02">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">Organization</span></a></li>
...
<section class="c-section " id="sec01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="p-org-chart p-org-chart--en">
  <p class="p-org-chart__txt">as of April 1, 2026</p>
  <ul class="p-org-chart__content">
    <li class="p-org-chart__topItem">
      <span class="p-org-chart__topItemIndent p-org-chart__topItemIndent--none">Board of Directors</span>
      <span class="p-org-chart__topItemIndent p-org-chart__topItemIndent1">Board of Directors Office</span>
    </li>
    <li class="p-org-chart__topItem">
      <span class="p-org-chart__topItemIndent p-org-chart__topItemIndent--none">Audit &amp; Supervisory Board</span>
      <span class="p-org-chart__topItemIndent p-org-chart__topItemIndent2">Audit &amp; Supervisory Board Office</span>
    </li>
    <li>
      <ul class="p-org-chart__list">
        <li class="p-org-chart__topItem">
          <span class="p-org-chart__topItemIndent p-org-chart__topItemIndent--none">President</span>
        </li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">North America Management Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">EMEA Management Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Latin America Management Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Asia-Pacific Management Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Japan Management Division</span></li>

        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">RICOH Digital Products Business Unit</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">RICOH Graphic Communications Business Unit</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">RICOH Industrial Solutions Business Unit</span></li>

        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">RICOH Software Business Unit</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Integration Marketing Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Corporate Planning Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">SCM Division</span></li>

        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Finance and Accounting Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Human Resources and General Affairs Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">ESG Strategy Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Digital Transformation Division</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent1">Technology Division</span></li>

        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent2">Internal Audit Office</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent2">Ricoh Institute of Sustainability &amp; Business</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent2">Security Management Center</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent2">Future Design Center</span></li>
        <li class="p-org-chart__item"><span class="p-org-chart__indent p-org-chart__indent3">Secretarial Office</span></li>
      </ul>
    </li>
  </ul>
</div>            </div>
...
G.mfx.router_mode = "history";
        ...
        <script type="module" src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/about/organization/js/script.js"></script>
