...
<li>
  <a href="../">About RICOH</a>
                                    ...
                                    <span>Corporate Videos, Corporate Publications</span>
                                </li>
                </ul>
            </div>
        </div>
  ...
  <li class="c-globalNav__item" data-drawer-button="03">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="03" id="globalNavDrawerControlsId-03">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">Corporate Videos &amp; Publications</span></a></li>
      </ul>
    </div>
  </li>
  <li class="c-globalNav__item">
    ...
    <section class="c-mv" data-mv="area" id="freepagetitle">
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/video/img/ad-search/mv.png" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/video/img/ad-search/mv.png&quot;);"></div>
  ...
  <div class="c-margin-a">
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item">
          <a href="#section01" class="c-ancLink-a__link">Vision･Concept</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section02" class="c-ancLink-a__link">Business Introduction</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section03" class="c-ancLink-a__link">Corporate Publications</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section04" class="c-ancLink-a__link">Printed Version (Integrated Report, Corporate Profile)</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Vision･Concept</h2>
                    </div>
                ...
                <div class="c-linkCard__item c-linkCard__item--layout3">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">The Ricoh Journey: Inspiring Change [3:26]</h3>
                                </div>
                            </div>
                        ...
                        <div class="c-linkCard__inner">
                                <div class="c-linkCard__titlewrap">
                                    <div class="c-h3-a">
                                        <h3 class="c-h3-a__text">Fulfillment through Work [2:08]</h3>
                                    </div>
                                </div>
                                                                                        <div class="c-linkCard__imagewrap">
                        ...
                        <div class="c-linkCard__inner">
                                <div class="c-linkCard__titlewrap">
                                    <div class="c-h3-a">
                                        <h3 class="c-h3-a__text">Working without Drama [2:04]</h3>
                                    </div>
                                </div>
                                                                                        <div class="c-linkCard__imagewrap">
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Business Introduction</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col3">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout3">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Workplace Experience Solution [1:57]</h3>
                                </div>
                            </div>
                                                                            <div class="c-linkCard__imagewrap">
                        ...
                        <div class="c-linkCard__inner">
                                <div class="c-linkCard__titlewrap">
                                    <div class="c-h3-a">
                                        <h3 class="c-h3-a__text">Process Automation Solution [1:23]</h3>
                                    </div>
                                </div>
                                                                                        <div class="c-linkCard__imagewrap">
...
<br>
  ...
  <div class="c-linkCard c-linkCard--col3">
    <div class="c-linkCard__item">
      <a href="../integrated-report/2025/" class="c-linkCard__link">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">Integrated Report</div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/com/about/video/img/ad-search/global-15-2" alt="">
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/facts/corporate-profile/pdf/20260109_e.pdf/" class="c-linkCard__link c-linkCard__link--pdf" target="_blank">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">Corporate Profile (English, PDF: 4MB)</div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/video/img/profile-202601.webp" alt="">
          </div>
        </div>
      </a>
    </div>
    <div class="c-linkCard__item">
      <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/jp_ricoh/about/facts/corporate-profile/pdf/20251223_j.pdf/" class="c-linkCard__link c-linkCard__link--pdf" target="_blank">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <div class="c-h4-a__text c-linkCard__hoverRed">Corporate Profile (Japanese, PDF: 4.34MB)</div>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/jp_ricoh/about/request/img/profile-202512" alt="">
          </div>
        </div>
      </a>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Printed Version (Integrated Report, Corporate Profile)</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout2">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-text-a">
  <p class="c-text-a__text">You can receive a printed version of the publications below.</p>
</div>
<div class="c-link-a-list c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="../integrated-report/" class="c-link-a icon-hidden">
      ...
      <span class="c-link-a__text">Ricoh Group Integrated Report (English / Japanese)</span>
    </a>
    <a href="" class="c-link-a icon-hidden">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">Corporate Profile (English / Japanese)</span>
    </a>
  </div>
</div>
<div class="c-text-a">
...
<div class="c-attention-a">
  <ul class="c-attention-a__list">
    <li class="c-attention-a__item">
      ...
      <div class="c-attention-a__text">The information you input will not be used for any purpose other than delivery and for sending of a report questionnaire mail. For details, please read the Ricoh Privacy Policy.</div>
    </li>
  </ul>
</div>
<div class="c-link-a-list  c-link-a-list--column">
  <div class="c-link-a-list__inner">
    <a href="../../privacy/" class="c-link-a icon-hidden">
      <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
      <span class="c-link-a__text">The details of the Ricoh Group Privacy Policy.</span>
    </a>
  </div>
</div>
                            </div>
