...
<title>Global Network | Global | Ricoh</title>
  ...
  <li class="c-globalNav__item" data-drawer-button="02">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="02" id="globalNavDrawerControlsId-02">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">Global Network</span></a></li>
    ...
    <section class="c-mv c-mv--2column" data-mv="area" id="freepagetitle">
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__container">
                    <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/global-network/img/img_main.jpg" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/global-network/img/img_main.jpg&quot;);"></div>
                </div>
            <div class="c-margin-b__inner">
                <div class="c-mv__inner">
                    <div class="c-mv__balloon">
                        ...
                        <h1 class="c-h1-a">
                                <span class="c-mv__text">Anytime Anywhere Support</span>
                            Global Network
                        </h1>
                                    </div>
            </div>
...
<section class="c-section " id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-text-a">
  <p class="c-text-a__text">Stress-free teamwork across borders and time zones can be a challenge. So Ricoh has built a global network for smooth collaboration between employees and partners in various countries.</p>
</div>            </div>
        </div>
    </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Find Ricoh anywhere</h2>
                    </div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-text-a">
  <p class="c-text-a__text">We have sales, support, production, research and development operations in around 200 countries. So we are there to support you anytime and anywhere you need it. Moreover, Ricoh products and services are globally streamlined and consistent, for hassle-free support with a worldwide reach. If you work at a global enterprise and need a globally consistent professional approach, RICOH Global Services is at the ready.</p>
</div>
                            </div>
                                            </div>
                </div>
    ...
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Putting feedback to work</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">We value our customers’ feedback. We take requests and expressed concerns seriously, and we put that feedback to work in improving our products, services, and support. And with factories and R&amp;D facilities distributed worldwide, we are agile. We expedite new product development, taking full account of local opinions, requests, and needs.</p>
</div>
                            </div>
                                            </div>
                </div>
...
</section><section class="c-section c-section--gray" id="section04">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Face-to-face with customers everywhere</h2>
                    </div>
                    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">We may all be living in a digitized world, but face-to-face interaction is as important as ever. Ricoh creates as many opportunities as possible to meet up with customers in their offices, our showrooms, at events, and shows. And RICOH Customer Experience Centers (CECs) in the United States, the United Kingdom, Thailand, and Japan are there for customers with an interest in commercial/industrial printing. Take the opportunity to see our products and technologies close up, and talk business with someone at Ricoh.</p>
</div>
...
</section><section class="c-section c-section--vista-white" id="section05">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">View our locations</h2>
                    </div>
                <div class="c-linkCard__item u-dsp-f" style="justify-content: center;">
  <a href="../location/" class="c-linkCard__link c-linkCard__link--blank u-mw-500">
    <div class="c-linkCard__text">
      <div class="c-h4-a">
        <div class="c-h4-a__text c-linkCard__hoverRed u-align-center">learn more</div>
      </div>
    </div>
    <div class="c-linkCard__image">
      <div class="c-linkCard__imageInner">
        <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/51C62D8BA819482D97E44F3B323449B4.ashx" alt="">
      </div>
    </div>
  </a>
</div>            </div>
