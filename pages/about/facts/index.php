...
<title>Company Data | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] Company Data">
<meta property="og:title" content="Company Data | Global | Ricoh">
    ...
    <meta property="og:description" content="Company Data">
<meta property="og:url" content="__RH_BASE__/about/facts">
...
@media screen and (min-width: 640.02px) {
  #section02 .c-linkCard.c-linkCard--col2 {
...
<ul class="c-globalNav__list">
  ...
  <li class="c-globalNav__item" data-drawer-button="02">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="02" id="globalNavDrawerControlsId-02">
      <ul class="c-globalNav-drawer__list">
        ...
        <li class="c-globalNav-drawer__item"><a href="board/" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">The Board</span></a></li>
  ...
  <li class="c-globalNav__item" data-drawer-button="03">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="03" id="globalNavDrawerControlsId-03" style="left: -54.2656px;">
      <ul class="c-globalNav-drawer__list">
...
<section class="c-section " id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                <div class="c-table u-align-left">
  <table>
    ...
    <tbody>
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Company Name</th>
        <td>Ricoh Company, Ltd.</td>
      </tr>
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Date of Establishment</th>
        <td>February 6, 1936</td>
      </tr>
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Head Office</th>
        <td>
          <dl>
            <dt>3-6, Nakamagome 1-chome, Ohta-ku, Tokyo 143-8555 Japan</dt>
            <dt>+81 3-3777-8111</dt>
            <dt>
              <div class="c-link-a-list">
                <div class="c-link-a-list__inner">
                  <a href="__RH_BASE__/" class="c-link-a c-link-a--blank icon-hidden" target="_blank">
                    ...
                    <span class="c-link-a__text">Google Map</span>
                  </a>
                </div>
              </div>
            </dt>
      ...
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Representative Director</th>
        <td>
          <dl>
            <dt>Akira Oyama President and CEO</dt>
            <dt>
              <div class="c-link-a-list">
                <div class="c-link-a-list__inner">
                  <a href="board/" class="c-link-a icon-hidden">
                    ...
                    <span class="c-link-a__text">The board</span>
                  </a>
                </div>
              </div>
            </dt>
      ...
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Capitalization</th>
        <td>135.3 billion yen (as of March 31, 2026)</td>
      </tr>
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Consolidated Net Sales</th>
        <td>2,608.3 billion yen (year ended March 31, 2026)</td>
      </tr>
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Number of Subsidiaries and Affiliates</th>
        <td>246 companies (as of March 31, 2026)</td>
      </tr>
      <tr>
        <th rowspan="1" class="u-v-align-top u-bgc-f6f6f6">Business Domains</th>
        <td colspan="2">
          <dl>
            <dt><strong>Digital Services</strong></dt>
            <dd>Sale of MFPs (multifunctional printers), laser printers, digital duplicators, wide format printers, facsimile machine, scanners, personal computers, servers, network equipment, related parts &amp; supplies, services, support, software and service &amp; solutions related to documents</dd>
            <dt><strong>Digital Products</strong></dt>
            <dd>Production and OEM of MFPs (multifunctional printers), laser printers, digital duplicators, wide format printers, facsimile machine, scanners, network equipment, related parts &amp; supplies, and production and sales of electronic components</dd>
            <dt><strong>Graphic Communications</strong></dt>
            <dd>Production and sales of cut sheet printers, continuous feed printer, inkjet heads, imaging systems, industrial printers, related parts &amp; supplies, services, support and software</dd>
            <dt><strong>Industrial Solutions</strong></dt>
            <dd>Production and sales of thermal paper and thermal media, industrial optical component/module and precision mechanical component</dd>
            <dt><strong>Other</strong></dt>
            <dd>Digital cameras, 360° cameras, environment, healthcare</dd>
          </dl>
          <p class="u-pt-16">(year ended March 31, 2026)</p>
        </td>
      </tr>
      <tr>
        <th rowspan="1" class="u-bgc-f6f6f6">Number of Employees</th>
        <td>75,635 (on consolidated basis, as of March 31, 2026)</td>
      </tr>
      <tr>
        <th rowspan="1" class="u-v-align-top u-bgc-f6f6f6">Main Offices</th>
        <td colspan="2">
          <dl>
              ...
              <div class="c-link-a-list">
                <div class="c-link-a-list__inner">
                  <a href="../../" class="c-link-a icon-hidden">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
                    <span class="c-link-a__text">Ricoh Company, Ltd. (Tokyo, Japan)</span>
                  </a>
                </div>
              </div>
            </dd>
            <dt>Regional Headquarters</dt>
            <dd>
              <div class="c-text-a u-mb-0">
                <p class="c-text-a__text">North America</p>
              </div>
              <div class="c-link-a-list u-mt-0">
                <div class="c-link-a-list__inner">
                  <a href="__RH_BASE__/" class="c-link-a c-link-a--blank icon-hidden" target="_blank">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/blank-primary-color.svg" alt="Open new window">
                    <span class="c-link-a__text">Ricoh USA, Inc. (Exton, U.S.A)</span>
                  </a>
                </div>
              </div>
            </dd>
            <dd>
              <div class="c-text-a u-mb-0">
                <p class="c-text-a__text">Latin America</p>
              </div>
              <div class="c-link-a-list u-mt-0">
                <div class="c-link-a-list__inner">
                  <a href="__RH_BASE__/" class="c-link-a c-link-a--blank icon-hidden" target="_blank">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/blank-primary-color.svg" alt="Open new window">
                    <span class="c-link-a__text">Ricoh Latin America, Inc.(Florida, U.S.A.)</span>
                  </a>
                </div>
              </div>
            </dd>
            <dd>
              <div class="c-text-a u-mb-0">
                <p class="c-text-a__text">Europe/Middle East/Africa</p>
              </div>
              <div class="c-link-a-list u-mt-0">
                <div class="c-link-a-list__inner">
                  <a href="__RH_BASE__/" class="c-link-a c-link-a--blank icon-hidden" target="_blank">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/blank-primary-color.svg" alt="Open new window">
                    <span class="c-link-a__text">Ricoh Europe PLC (London, UK)</span>
                  </a>
                </div>
              </div>
            </dd>
            <dd>
              <div class="c-text-a u-mb-0">
                <p class="c-text-a__text">Asia/Pacific</p>
              </div>
              <div class="c-link-a-list u-mt-0">
                <div class="c-link-a-list__inner">
                  <a href="__RH_BASE__/" class="c-link-a c-link-a--blank icon-hidden" target="_blank">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/blank-primary-color.svg" alt="Open new window">
                    <span class="c-link-a__text">Ricoh Asia Pacific Pte Ltd. (Singapore, Singapore)</span>
                  </a>
                </div>
              </div>
            </dd>
            <dd class="u-mb-8">
              <div class="c-text-a u-mb-0">
                <p class="c-text-a__text">Japan</p>
              </div>
              <div class="c-link-a-list u-mt-0">
                <div class="c-link-a-list__inner">
                  <a href="__RH_BASE__/" class="c-link-a icon-hidden">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
                    <span class="c-link-a__text">Ricoh Japan Corporation (Tokyo, Japan)</span>
                  </a>
                </div>
              </div>
            </dd>
            <dt>
              <div class="c-link-a-list">
                <div class="c-link-a-list__inner">
                  <a href="../location/" class="c-link-a icon-hidden">
                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-right-primary-color.svg" alt="">
                    <span class="c-link-a__text">Global Directory</span>
                  </a>
                </div>
              </div>
            </dt>
  ...
  <div class="c-linkCard c-linkCard--col3">
      ...
      <div class="c-linkCard__inner">
        <figure class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/facts/img/profile202601.webp" alt="">
          </div>
        </figure>
        <div class="c-h4-a c-h4-a--narrow">
          <h4 class="c-h4-a__text">Corporate Profile</h4>
        </div>
        <div class="c-link-a-list">
          <div class="c-link-a-list__inner">
            <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/facts/corporate-profile/pdf/20260109_e.pdf/" class="c-link-a c-link-a--pdf icon-hidden" target="_blank">
              <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
              <span class="c-link-a__text">English (PDF:4MB)</span>
            </a>
          </div>
          <div class="c-link-a-list__inner">
            <a href="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Sites/jp_ricoh/about/facts/corporate-profile/pdf/20251223_j.pdf/" class="c-link-a c-link-a--pdf icon-hidden" target="_blank">
              <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/icon_pdf.png" alt="Pdf download">
              <span class="c-link-a__text">Japanese (PDF:4.34MB)</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="c-linkCard__item">
      <a href="../at-a-glance/" class="c-linkCard__link">
        <div class="c-linkCard__text">
          <div class="c-h4-a">
            <h3 class="c-h4-a__text c-linkCard__hoverRed">Ricoh at a Glance</h3>
          </div>
        </div>
        <div class="c-linkCard__image">
          <div class="c-linkCard__imageInner">
            <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/img/recommend/pic_1-2_pc.jpg" alt="">
          </div>
        </div>
      </a>
    </div>
