...
<ul class="c-globalNav__list">
  ...
  <li class="c-globalNav__item">
    <a href="" class="c-globalNav__link">Careers</a>
  </li>
</ul>                                                                                    </div>
                                    </div>
                                </div>
    ...
    <section class="c-mv" data-mv="area" id="freepagetitle">
        <div class="c-margin-b c-margin-b--large">
                <div class="c-mv__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/jobs/img/img-main-careers-2.jpg" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/jobs/img/img-main-careers-2.jpg&quot;);"></div>
...
<section class="c-section " id="section06">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
                        <h2 class="c-h2-a__text">Please select your local website</h2>
                    </div>
                <div class="c-text-a">
  <p class="c-text-a__text u-align-center">Please find out if there are employment opportunities in a country of your choice.</p>
</div>            </div>
        </div>
    </div>
    ...
    <div class="c-margin-a__inner">
      <ul class="c-ancLink-a__list">
        <li class="c-ancLink-a__item">
          <a href="#section01" class="c-ancLink-a__link">North America</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section02" class="c-ancLink-a__link">Latin America</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section03" class="c-ancLink-a__link">Europe/Middle East/Africa</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section04" class="c-ancLink-a__link">Asia/Pacific</a>
        </li>
        <li class="c-ancLink-a__item">
          <a href="#section05" class="c-ancLink-a__link">Japan</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="c-text-a">
  <p class="c-text-a__text u-font-bold u-fz-18">
    Other Country
  </p>
  <p class="c-text-a__text">
    If the country that you are looking for is not on the list above, please go to the Regional HQ website.
  </p>
</div>
        ...
        <div class="c-linkCard c-linkCard--col1 c-linkCard--col1-wide">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                            <div class="c-linkCard__titlewrap">
                                <div class="c-h3-a">
                                    <h3 class="c-h3-a__text">Japan</h3>
                                </div>
                            </div>
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-linkColumn c-linkColumn--col3"><!-- c-linkColumn--colXの数字を1-5で変更することで、カラム数を1-5カラムで設定することがきます。 -->
