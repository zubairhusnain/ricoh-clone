...
<title>To Our Stakeholders | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] To Our Stakeholders">
<meta property="og:title" content="To Our Stakeholders | Global | Ricoh">
    ...
    <meta property="og:description" content="To Our Stakeholders">
<meta property="og:url" content="https://www.ricoh.com/about/to-our-stakeholders">
...
@media screen and (min-width: 640.02px) {
  #section01 .c-linkCard.c-linkCard--col2 {
  ...
  <li class="c-globalNav__item" data-drawer-button="01">
    ...
    <div class="c-globalNav-drawer__box" data-drawer-inner="01" id="globalNavDrawerControlsId-01">
      <ul class="c-globalNav-drawer__list">
        <li class="c-globalNav-drawer__item"><a href="" class="c-globalNav-drawer__link"><span class="c-globalNav-drawer__text">To Our Stakeholders</span></a></li>
...
<section class="c-section " id="section01">
    <div class="f-child">
        <div class="c-margin-b">
            <div class="c-margin-b__inner">
                    <div class="c-h2-a">
        <h2 class="c-h2-a__text">Message from the Chairperson</h2>
    </div>
        ...
        <div class="c-linkCard c-linkCard--col2 c-linkCard--col-reverse">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                ...
                                <div class="c-text-a">
  <p class="c-text-a__text">The founder of the Ricoh Group, Kiyoshi Ichimura, established the Spirit of Three Loves— “Love your neighbor” “Love your country” “Love your work” —as the unwavering foundation of Ricoh’s corporate activities. Our approach of placing ESG and business activities on the same axis carries forward this spirit and serves as a guiding principle for our decisions and actions.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">We position our ESG targets as “Future Financial Targets,” believing that the ESG initiatives undertaken to achieve them will drive long-term growth. Through our business, we create value for society, and that value helps to sustainably enhance people’s well-being. As society becomes more sustainable, companies are also able to grow. We believe that by continuing this cycle, we build trust as a company.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Through this positive cycle of value creation, the Ricoh Group aims to continue earning the trust of all stakeholders and to remain their company of choice.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text u-align-right">April 1, 2026</p>
</div>
                            </div>
                                            </div>
                </div>
                        ...
                        <div class="c-linkCard__inner">
                                        ...
                                        <figure class="c-linkCard__image">
                                                <div class="c-linkCard__imageInner c-linkCard__imageInner--noRatio">
                                                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/to-our-stakeholders/img/message01.jpg" alt="">
                                                </div>
                                            <figcaption class="c-caption">
                                                <div class="c-text-a c-text-a--thin">
                                                    <p class="c-text-a__text">Yoshinori “Jake” Yamashita<br>Chairperson</p>
                                                </div>
                                            </figcaption>
                                        </figure>
                                </div>
    ...
    <div class="c-h2-a">
        <h2 class="c-h2-a__text">Message from the CEO</h2>
    </div>
    <div class="c-multiCol">
        <div class="c-linkCard c-linkCard--col2 c-linkCard--col-reverse">
                ...
                <div class="c-linkCard__item c-linkCard__item--layout1">
                    <div class="c-linkCard__inner">
                                                    <div class="c-linkCard__textwrap">
                                <div class="c-text-a">
  <p class="c-text-a__text">Since its founding in 1936, Ricoh has remained close to the changing nature of work through 90 years of business activities.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">As technologies such as AI continue to advance rapidly, the way our customers work is also constantly evolving. We are driving the transformation of work to help strengthen our customers’ competitive advantage and differentiation.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">Ricoh has set “Fulfillment through Work” as its mission and vision. We believe work brings a true sense of fulfillment when it enables people to tap into their uniquely human capacity for creativity, and when it leads to a sense of accomplishment and self-realization.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text">To bring this vision to life, we will continue to drive innovation, support the creativity of working people, and contribute to building a more sustainable society.</p>
</div>
<div class="c-text-a">
  <p class="c-text-a__text u-align-right">April 1, 2026</p>
</div>
                        ...
                        <div class="c-linkCard__inner">
                                        ...
                                        <figure class="c-linkCard__image">
                                                <div class="c-linkCard__imageInner c-linkCard__imageInner--noRatio">
                                                    <img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/to-our-stakeholders/img/message02.jpg" alt="">
                                                </div>
                                            <figcaption class="c-caption">
                                                <div class="c-text-a c-text-a--thin">
                                                    <p class="c-text-a__text">Akira Oyama<br>President and CEO</p>
                                                </div>
                                            </figcaption>
                                        </figure>
                                </div>
