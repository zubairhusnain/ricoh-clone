...
<title>Advertising &amp; Sponsorship | Global | Ricoh</title>
    <meta name="Description" content="[Ricoh Global Official Website] This is Ricoh's advertising page. This page introduces TV commercials, newspaper and magazine advertisements, and various events and sponsorships.">
<meta property="og:title" content="Advertising &amp; Sponsorship | Global | Ricoh">
    ...
    <meta property="og:description" content="This is Ricoh's advertising page. This page introduces TV commercials, newspaper and magazine advertisements, and various events and sponsorships.">
<meta property="og:url" content="https://www.ricoh.com/about/advertisement">
...
<div class="c-container" id="ownedindex">
            ...
            <div class="c-margin-b">
                <div class="c-margin-b__inner">
                    <div class="c-mv-stories__content">
                        <a href="expo2025-kurage/" class="c-mv-stories__link">
                                <div class="c-mv-stories__lead">PickUp</div>
                                                            <div class="c-mv-stories__heading">
                                    <span class="c-mv-stories__heading__title">Advanced Ricoh Technologies to Enhance Expo 2025 Pavilion to Contribute to Social Progress beyond Fulfillment through Work</span>
                                </div>
                                                            <div class="c-mv-stories__info">
                                        <span class="c-mv-stories__date">2025.03.28</span>
                                                                            <span class="c-newsIcon c-mv-stories__hoverRed">Events / Sponsorship</span>
                                </div>
                                    ...
                                    <div class="c-tagList-a">
                                        <ul class="c-tagList-a__list">
                                                <li class="c-tagList-a__item c-tagList-a__item--blue">
                                                    <span class="c-tagList-a__link c-tagList-a__link--noHover">Fulfillment through Work</span>
                                                </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="c-mv-stories__image" data-sec-bg="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/advertisement/expo2025-kurage/img/thumb.webp" style="background-image: url(&quot;/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/advertisement/expo2025-kurage/img/thumb.webp&quot;);"></div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="anc01" class="c-section">
            <div class="f-child">
                <div class="c-margin-b">
                    <div class="c-margin-b__inner">
                                                                            <div id="ownedIndexVue" data-v-app=""><div class="c-newsFilter"><fieldset><legend><span class="c-newsFilter__name">Narrow down</span></legend><div class="c-newsFilter__items"><label class="c-newsFilter__label"><input type="radio" class="c-newsFilter__input" name="newsFilter" value="ALL"><span class="c-newsFilter__button"><span class="c-newsFilter__text">ALL</span></span></label><label class="c-newsFilter__label"><input type="radio" class="c-newsFilter__input" name="newsFilter" value="Events / Sponsorship"><span class="c-newsFilter__button"><span class="c-newsFilter__text">Events / Sponsorship</span></span></label></div></fieldset></div><div class="c-multiCol"><div class="c-linkCard c-linkCard--col3"><div set="Events / Sponsorship" class="c-linkCard__item"><a href="expo2025-kurage/" class="c-linkCard__link icon-hidden"><div class="c-linkCard__text"><div class="c-h4-a"><div class="c-h4-a__text c-linkCard__hoverRed">Advanced Ricoh Technologies to Enhance Expo 2025 Pavilion to Contribute to Social Progress beyond Fulfillment through Work</div></div></div><div class="c-linkCard__info"><span class="c-linkCard__date c-linkCard__hoverRed">2025.03.28</span><span class="c-newsIcon c-linkCard__hoverRed">Events / Sponsorship</span></div><div class="c-linkCard__image"><div class="c-linkCard__imageInner"><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/advertisement/expo2025-kurage/img/thumb.webp" alt=""></div><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg" alt=""></div></a><div class="c-linkCard__tag c-tagList-a"><ul class="c-tagList-a__list"><li class="c-tagList-a__item c-tagList-a__item--blue"><span class="c-tagList-a__link c-tagList-a__link--noHover">#Fulfillment through Work</span></li></ul></div></div></div></div><div class="c-buttonWrap-b"><div class="c-buttonWrap-b__content u-align-center"><button type="button" class="c-button-a c-button-a--thin c-button-a--white c-button-a--arrow c-button-a--arrowDown c-button-a--iconRed icon-hidden" style="display: none;"><span class="c-button-a__text">Read More</span><img src="/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/Media/Ricoh/Common/cmn_v3/img/svg/arrow-bottom-primary-color.svg" alt=""></button></div></div></div>
                            <script>
                                var ricoh = ricoh || {};
                                ricoh.co = ricoh.co || {};
                                ...
                                ricoh.co.jp.Items = [{"image":{"path":"/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Sites/com/about/advertisement/expo2025-kurage/img/thumb.webp","alt":""},"date":"2025.03.28","labels":[{"name":"Events / Sponsorship","id":0}],"title":"Advanced Ricoh Technologies to Enhance Expo 2025 Pavilion to Contribute to Social Progress beyond Fulfillment through Work","tags":["Fulfillment through Work"],"linkdata":{"url":"/about/advertisement/expo2025-kurage","target":null,"iconurl":"/ricoh-clone/ricoh_offline/assets/www.ricoh.com/-/media/Ricoh/Common/cmn_v3/img/svg/arrow-right-white-color.svg","iconalt":""}}];
                                ricoh.co.jp.Labels = [{"name":"Events / Sponsorship","id":0}];
                            </script>
